    ...
    namespace source {
      namespace util {
        abstract class DocTrees extends com.sun.source.util.Trees {
          ...
          public abstract getDocCommentTree(
          ...
          public abstract getDocTreePath(
            arg0: javax.tools.FileObject,
            arg1: javax.lang.model.element.PackageElement
          ...
          public abstract getFirstSentence(
          ...
          public abstract printMessage(
            ...
            arg3: com.sun.source.doctree.DocCommentTree,
            arg4: com.sun.source.tree.CompilationUnitTree
          ): void
