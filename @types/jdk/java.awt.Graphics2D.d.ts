  ...
  namespace awt {
    abstract class Graphics2D extends java.awt.Graphics {
      ...
      public abstract drawImage(
        arg0: java.awt.Image,
        arg1: java.awt.geom.AffineTransform,
        arg2: java.awt.image.ImageObserver | java.awt.image.ImageObserver$$lambda
      ): boolean
      public abstract drawImage(
        arg0: java.awt.image.BufferedImage,
        arg1: java.awt.image.BufferedImageOp,
        arg2: number | java.lang.Integer,
        arg3: number | java.lang.Integer
      ): void
      public abstract drawRenderedImage(arg0: java.awt.image.RenderedImage, arg1: java.awt.geom.AffineTransform): void
      public abstract drawRenderableImage(
        arg0: java.awt.image.renderable.RenderableImage,
        arg1: java.awt.geom.AffineTransform
      ): void
      public abstract drawString(
      ...
      public abstract drawGlyphVector(
        arg0: java.awt.font.GlyphVector,
        arg1: number | java.lang.Float,
        arg2: number | java.lang.Float
      ): void
