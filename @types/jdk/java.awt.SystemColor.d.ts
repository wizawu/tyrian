declare namespace java {
  namespace awt {
    ...
    class SystemColor extends java.awt.Color implements java.io.Serializable {
      ...
      public static readonly ACTIVE_CAPTION_BORDER: int
      public static readonly INACTIVE_CAPTION: int
      public static readonly INACTIVE_CAPTION_TEXT: int
      public static readonly INACTIVE_CAPTION_BORDER: int
      public static readonly WINDOW: int
      public static readonly WINDOW_BORDER: int
      public static readonly WINDOW_TEXT: int
      public static readonly MENU: int
      public static readonly MENU_TEXT: int
      public static readonly TEXT: int
      public static readonly TEXT_TEXT: int
      public static readonly TEXT_HIGHLIGHT: int
      public static readonly TEXT_HIGHLIGHT_TEXT: int
      public static readonly TEXT_INACTIVE_TEXT: int
      public static readonly CONTROL: int
      public static readonly CONTROL_TEXT: int
      public static readonly CONTROL_HIGHLIGHT: int
      public static readonly CONTROL_LT_HIGHLIGHT: int
      public static readonly CONTROL_SHADOW: int
      public static readonly CONTROL_DK_SHADOW: int
      public static readonly SCROLLBAR: int
      public static readonly INFO: int
      public static readonly INFO_TEXT: int
      public static readonly NUM_COLORS: int
