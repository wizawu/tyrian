  ...
  namespace awt {
    namespace image {
      ...
      abstract class PackedColorModel extends java.awt.image.ColorModel {
        ...
        maskOffsets: int[]
        scaleFactors: float[]
        public constructor(arg0: java.awt.color.ColorSpace, arg1: number | java.lang.Integer, arg2: number[] | java.lang.Integer[], arg3: number | java.lang.Integer, arg4: boolean | java.lang.Boolean, arg5: number | java.lang.Integer, arg6: number | java.lang.Integer)
