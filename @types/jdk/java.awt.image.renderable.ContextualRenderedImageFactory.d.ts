      ...
      namespace renderable {
        interface ContextualRenderedImageFactory extends java.awt.image.renderable.RenderedImageFactory {
          mapRenderContext(
            ...
            arg1: java.awt.image.renderable.RenderContext,
            arg2: java.awt.image.renderable.ParameterBlock,
            arg3: java.awt.image.renderable.RenderableImage
          ): java.awt.image.renderable.RenderContext
          create(
            arg0: java.awt.image.renderable.RenderContext,
            arg1: java.awt.image.renderable.ParameterBlock
