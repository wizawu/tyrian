  ...
  namespace lang {
    namespace reflect {
      ...
      abstract class Executable extends java.lang.reflect.AccessibleObject implements java.lang.reflect.Member, java.lang.reflect.GenericDeclaration {
        constructor()
        abstract getAnnotationBytes(): byte[]
        ...
        printModifiersIfNonzero(arg0: java.lang.StringBuilder, arg1: int, arg2: boolean): void
        sharedToString(arg0: int, arg1: boolean, arg2: java.lang.Class<unknown>[], arg3: java.lang.Class<unknown>[]): java.lang.String
        abstract specificToStringHeader(arg0: java.lang.StringBuilder): void
        sharedToGenericString(arg0: int, arg1: boolean): java.lang.String
        ...
        abstract handleParameterNumberMismatch(arg0: int, arg1: int): boolean
        ...
        getAnnotatedReturnType0(arg0: java.lang.reflect.Type): java.lang.reflect.AnnotatedType
