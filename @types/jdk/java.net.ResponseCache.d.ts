declare namespace java {
  namespace net {
    ...
    abstract class ResponseCache {
      ...
      public abstract get(arg0: java.net.URI, arg1: java.lang.String, arg2: java.util.Map<java.lang.String,java.util.List<java.lang.String>>): java.net.CacheResponse
