  ...
  namespace net {
    namespace http {
      class HttpRequest$BodyPublishers {
        public static fromPublisher(
          arg0:
            | java.util.concurrent.Flow$Publisher<java.nio.ByteBuffer>
            | java.util.concurrent.Flow$Publisher$$lambda<java.nio.ByteBuffer>
