  ...
  namespace net {
    namespace http {
      ...
      class HttpResponse$BodyHandlers {
        ...
        public static fromLineSubscriber<S extends java.util.concurrent.Flow$Subscriber<unknown>,T>(arg0: S, arg1: java.util.function$.Function<unknown,T>, arg2: java.lang.String | string): java.net.http.HttpResponse$BodyHandler<T>
        ...
        public static ofFile(arg0: java.nio.file.Path, ...vargs: (java.nio.file.OpenOption)[]): java.net.http.HttpResponse$BodyHandler<java.nio.file.Path>
        public static ofFile(arg0: java.nio.file.Path): java.net.http.HttpResponse$BodyHandler<java.nio.file.Path>
        public static ofFileDownload(arg0: java.nio.file.Path, ...vargs: (java.nio.file.OpenOption)[]): java.net.http.HttpResponse$BodyHandler<java.nio.file.Path>
        ...
        public static ofByteArrayConsumer(arg0: java.util.function$.Consumer<java.util.Optional<byte[]>> | java.util.function$.Consumer$$lambda<java.util.Optional<byte[]>>): java.net.http.HttpResponse$BodyHandler<java.lang.Void>
        ...
        public static buffering<T>(arg0: java.net.http.HttpResponse$BodyHandler<T> | java.net.http.HttpResponse$BodyHandler$$lambda<T>, arg1: number | java.lang.Integer): java.net.http.HttpResponse$BodyHandler<T>
      }
