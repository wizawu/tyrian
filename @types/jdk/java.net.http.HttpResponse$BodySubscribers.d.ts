  ...
  namespace net {
    namespace http {
      class HttpResponse$BodySubscribers {
        ...
        ): java.net.http.HttpResponse$BodySubscriber<java.lang.Void>
        ...
        ): java.net.http.HttpResponse$BodySubscriber<java.lang.String>
        ...
        ): java.net.http.HttpResponse$BodySubscriber<java.nio.file.Path>
        ...
        public static ofLines(
          arg0: java.nio.charset.Charset
        ): java.net.http.HttpResponse$BodySubscriber<java.util.stream.Stream<java.lang.String>>
        public static ofPublisher(): java.net.http.HttpResponse$BodySubscriber<
        ...
        public static buffering<T>(
          arg0: java.net.http.HttpResponse$BodySubscriber<T>,
          arg1: number | java.lang.Integer
        ): java.net.http.HttpResponse$BodySubscriber<T>
        public static mapping<T, U>(
          arg0: java.net.http.HttpResponse$BodySubscriber<T>,
          arg1: java.util.function$.Function<unknown, U>
        ): java.net.http.HttpResponse$BodySubscriber<U>
      }
    }
  }
}
