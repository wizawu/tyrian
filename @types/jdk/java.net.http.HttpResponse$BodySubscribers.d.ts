  ...
  namespace net {
    namespace http {
      ...
      class HttpResponse$BodySubscribers {
        ...
        public static fromLineSubscriber<S extends java.util.concurrent.Flow$Subscriber<unknown>,T>(arg0: S, arg1: java.util.function$.Function<unknown,T>, arg2: java.nio.charset.Charset, arg3: java.lang.String | string): java.net.http.HttpResponse$BodySubscriber<T>
        ...
        public static buffering<T>(arg0: java.net.http.HttpResponse$BodySubscriber<T>, arg1: number | java.lang.Integer): java.net.http.HttpResponse$BodySubscriber<T>
