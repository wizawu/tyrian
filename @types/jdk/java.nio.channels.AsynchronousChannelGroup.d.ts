  ...
  namespace nio {
    namespace channels {
      ...
      abstract class AsynchronousChannelGroup {
        ...
        public static withFixedThreadPool(arg0: number | java.lang.Integer, arg1: java.util.concurrent.ThreadFactory | java.util.concurrent.ThreadFactory$$lambda): java.nio.channels.AsynchronousChannelGroup
        public static withCachedThreadPool(arg0: java.util.concurrent.ExecutorService, arg1: number | java.lang.Integer): java.nio.channels.AsynchronousChannelGroup
