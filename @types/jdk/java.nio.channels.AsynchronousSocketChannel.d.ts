  ...
  namespace nio {
    namespace channels {
        ...
        implements java.nio.channels.AsynchronousByteChannel, java.nio.channels.NetworkChannel
      {
        ...
        public abstract connect<A>(
          arg0: java.net.SocketAddress,
          arg1: A,
          arg2: java.nio.channels.CompletionHandler<java.lang.Void, unknown>
        ): void
        ...
        public abstract read<A>(
          ...
          arg3: A,
          arg4: java.nio.channels.CompletionHandler<java.lang.Integer, unknown>
        ): void
        public read<A>(
          arg0: java.nio.ByteBuffer,
          arg1: A,
          arg2: java.nio.channels.CompletionHandler<java.lang.Integer, unknown>
        ): void
        ...
        public abstract read<A>(
          ...
          arg4: java.util.concurrent.TimeUnit,
          arg5: A,
          arg6: java.nio.channels.CompletionHandler<java.lang.Long, unknown>
        ): void
