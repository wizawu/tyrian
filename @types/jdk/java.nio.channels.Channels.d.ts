  ...
  namespace nio {
    namespace channels {
      ...
      class Channels {
        ...
        public static newReader(arg0: java.nio.channels.ReadableByteChannel, arg1: java.nio.charset.CharsetDecoder, arg2: number | java.lang.Integer): java.io.Reader
        public static newReader(arg0: java.nio.channels.ReadableByteChannel, arg1: java.lang.String | string): java.io.Reader
        public static newReader(arg0: java.nio.channels.ReadableByteChannel, arg1: java.nio.charset.Charset): java.io.Reader
        public static newWriter(arg0: java.nio.channels.WritableByteChannel, arg1: java.nio.charset.CharsetEncoder, arg2: number | java.lang.Integer): java.io.Writer
        public static newWriter(arg0: java.nio.channels.WritableByteChannel, arg1: java.lang.String | string): java.io.Writer
        public static newWriter(arg0: java.nio.channels.WritableByteChannel, arg1: java.nio.charset.Charset): java.io.Writer
      }
