    ...
    namespace channels {
      namespace spi {
        ...
        abstract class AsynchronousChannelProvider {
          ...
          public abstract openAsynchronousChannelGroup(arg0: number | java.lang.Integer, arg1: java.util.concurrent.ThreadFactory | java.util.concurrent.ThreadFactory$$lambda): java.nio.channels.AsynchronousChannelGroup
          public abstract openAsynchronousChannelGroup(arg0: java.util.concurrent.ExecutorService, arg1: number | java.lang.Integer): java.nio.channels.AsynchronousChannelGroup
