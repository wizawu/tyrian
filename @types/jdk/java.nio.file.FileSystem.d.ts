  ...
  namespace nio {
    namespace file {
      ...
      abstract class FileSystem implements java.io.Closeable {
        ...
        public abstract getPath(arg0: java.lang.String, ...arg1: java.lang.String[]): java.nio.file.Path
        public abstract getPathMatcher(arg0: java.lang.String): java.nio.file.PathMatcher
