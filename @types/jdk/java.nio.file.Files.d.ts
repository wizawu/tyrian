  ...
  namespace nio {
    namespace file {
      ...
      class Files {
        ...
        public static newByteChannel(arg0: java.nio.file.Path, arg1: java.util.Set<java.nio.file.OpenOption>, ...arg2: java.nio.file.attribute.FileAttribute<unknown>[]): java.nio.channels.SeekableByteChannel
        ...
        public static newDirectoryStream(arg0: java.nio.file.Path, arg1: java.lang.String): java.nio.file.DirectoryStream<java.nio.file.Path>
        public static newDirectoryStream(arg0: java.nio.file.Path, arg1: java.nio.file.DirectoryStream$Filter<unknown>): java.nio.file.DirectoryStream<java.nio.file.Path>
        public static createFile(arg0: java.nio.file.Path, ...arg1: java.nio.file.attribute.FileAttribute<unknown>[]): java.nio.file.Path
        public static createDirectory(arg0: java.nio.file.Path, ...arg1: java.nio.file.attribute.FileAttribute<unknown>[]): java.nio.file.Path
        public static createDirectories(arg0: java.nio.file.Path, ...arg1: java.nio.file.attribute.FileAttribute<unknown>[]): java.nio.file.Path
        public static createTempFile(arg0: java.nio.file.Path, arg1: java.lang.String, arg2: java.lang.String, ...arg3: java.nio.file.attribute.FileAttribute<unknown>[]): java.nio.file.Path
        public static createTempFile(arg0: java.lang.String, arg1: java.lang.String, ...arg2: java.nio.file.attribute.FileAttribute<unknown>[]): java.nio.file.Path
        public static createTempDirectory(arg0: java.nio.file.Path, arg1: java.lang.String, ...arg2: java.nio.file.attribute.FileAttribute<unknown>[]): java.nio.file.Path
        public static createTempDirectory(arg0: java.lang.String, ...arg1: java.nio.file.attribute.FileAttribute<unknown>[]): java.nio.file.Path
        public static createSymbolicLink(arg0: java.nio.file.Path, arg1: java.nio.file.Path, ...arg2: java.nio.file.attribute.FileAttribute<unknown>[]): java.nio.file.Path
        ...
        public static setAttribute(arg0: java.nio.file.Path, arg1: java.lang.String, arg2: java.lang.Object, ...arg3: java.nio.file.LinkOption[]): java.nio.file.Path
        public static getAttribute(arg0: java.nio.file.Path, arg1: java.lang.String, ...arg2: java.nio.file.LinkOption[]): java.lang.Object
        public static readAttributes(arg0: java.nio.file.Path, arg1: java.lang.String, ...arg2: java.nio.file.LinkOption[]): java.util.Map<java.lang.String,java.lang.Object>
        ...
        public static walkFileTree(arg0: java.nio.file.Path, arg1: java.util.Set<java.nio.file.FileVisitOption>, arg2: int, arg3: java.nio.file.FileVisitor<unknown>): java.nio.file.Path
        ...
        public static writeString(arg0: java.nio.file.Path, arg1: java.lang.CharSequence, ...arg2: java.nio.file.OpenOption[]): java.nio.file.Path
        public static writeString(arg0: java.nio.file.Path, arg1: java.lang.CharSequence, arg2: java.nio.charset.Charset, ...arg3: java.nio.file.OpenOption[]): java.nio.file.Path
