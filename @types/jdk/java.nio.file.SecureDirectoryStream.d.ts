  ...
  namespace nio {
    namespace file {
      ...
      interface SecureDirectoryStream<T> extends java.nio.file.DirectoryStream<T> {
        ...
        newByteChannel(arg0: T, arg1: java.util.Set<java.nio.file.OpenOption>, ...arg2: java.nio.file.attribute.FileAttribute<unknown>[]): java.nio.channels.SeekableByteChannel
