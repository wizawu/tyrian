  ...
  namespace nio {
    namespace file {
      ...
      interface SecureDirectoryStream<T> extends java.nio.file.DirectoryStream<T> {
        ...
        newByteChannel(arg0: T, arg1: java.util.Set<java.nio.file.OpenOption>, ...vargs: (java.nio.file.attribute.FileAttribute<unknown>)[]): java.nio.channels.SeekableByteChannel
        ...
        getFileAttributeView<V extends java.nio.file.attribute.FileAttributeView>(arg0: T, arg1: java.lang.Class<V>, ...vargs: (java.nio.file.LinkOption)[]): V
      }
