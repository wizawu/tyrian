    ...
    namespace file {
      namespace spi {
        ...
        abstract class FileSystemProvider {
          ...
          public newFileChannel(arg0: java.nio.file.Path, arg1: java.util.Set<java.nio.file.OpenOption>, ...arg2: java.nio.file.attribute.FileAttribute<unknown>[]): java.nio.channels.FileChannel
          public newAsynchronousFileChannel(arg0: java.nio.file.Path, arg1: java.util.Set<java.nio.file.OpenOption>, arg2: java.util.concurrent.ExecutorService, ...arg3: java.nio.file.attribute.FileAttribute<unknown>[]): java.nio.channels.AsynchronousFileChannel
          public abstract newByteChannel(arg0: java.nio.file.Path, arg1: java.util.Set<java.nio.file.OpenOption>, ...arg2: java.nio.file.attribute.FileAttribute<unknown>[]): java.nio.channels.SeekableByteChannel
          public abstract newDirectoryStream(arg0: java.nio.file.Path, arg1: java.nio.file.DirectoryStream$Filter<unknown>): java.nio.file.DirectoryStream<java.nio.file.Path>
          public abstract createDirectory(arg0: java.nio.file.Path, ...arg1: java.nio.file.attribute.FileAttribute<unknown>[]): void
          public createSymbolicLink(arg0: java.nio.file.Path, arg1: java.nio.file.Path, ...arg2: java.nio.file.attribute.FileAttribute<unknown>[]): void
          ...
          public abstract readAttributes(arg0: java.nio.file.Path, arg1: java.lang.String, ...arg2: java.nio.file.LinkOption[]): java.util.Map<java.lang.String,java.lang.Object>
          public abstract setAttribute(arg0: java.nio.file.Path, arg1: java.lang.String, arg2: java.lang.Object, ...arg3: java.nio.file.LinkOption[]): void
        }
