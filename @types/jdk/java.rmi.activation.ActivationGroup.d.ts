  ...
  namespace rmi {
    namespace activation {
      ...
      abstract class ActivationGroup extends java.rmi.server.UnicastRemoteObject implements java.rmi.activation.ActivationInstantiator {
        ...
        public static createGroup(arg0: java.rmi.activation.ActivationGroupID, arg1: java.rmi.activation.ActivationGroupDesc, arg2: number | java.lang.Long): java.rmi.activation.ActivationGroup
