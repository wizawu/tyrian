  ...
  namespace rmi {
    namespace activation {
      ...
      interface ActivationSystem extends java.rmi.Remote {
        public static readonly SYSTEM_PORT: int
        ...
        activeGroup(arg0: java.rmi.activation.ActivationGroupID, arg1: java.rmi.activation.ActivationInstantiator | java.rmi.activation.ActivationInstantiator$$lambda, arg2: number | java.lang.Long): java.rmi.activation.ActivationMonitor
