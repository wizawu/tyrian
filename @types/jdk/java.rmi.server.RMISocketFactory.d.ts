declare namespace java {
  namespace rmi {
    namespace server {
      abstract class RMISocketFactory
        implements java.rmi.server.RMIClientSocketFactory, java.rmi.server.RMIServerSocketFactory
      {
        public constructor()
        ...
        public static setFailureHandler(
          arg0: java.rmi.server.RMIFailureHandler | java.rmi.server.RMIFailureHandler$$lambda
        ): void
