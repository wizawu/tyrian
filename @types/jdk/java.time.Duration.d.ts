declare namespace java {
  namespace time {
    ...
    class Duration implements java.time.temporal.TemporalAmount, java.lang.Comparable<java.time.Duration>, java.io.Serializable {
      ...
      public dividedBy(arg0: java.time.Duration): long
      ...
      public toHoursPart(): int
      public toMinutesPart(): int
      public toSecondsPart(): int
      public toMillisPart(): int
      public toNanosPart(): int
