declare namespace java {
  namespace time {
    ...
    class ZonedDateTime implements java.time.temporal.Temporal, java.time.chrono.ChronoZonedDateTime<java.time.LocalDate>, java.io.Serializable {
      ...
      public getNano(): int
      public with(arg0: java.time.temporal.TemporalAdjuster): java.time.ZonedDateTime
      ...
      public minus(arg0: long, arg1: java.time.temporal.TemporalUnit): java.time.chrono.ChronoZonedDateTime
      public minus(arg0: java.time.temporal.TemporalAmount): java.time.chrono.ChronoZonedDateTime
      public plus(arg0: long, arg1: java.time.temporal.TemporalUnit): java.time.chrono.ChronoZonedDateTime
      public plus(arg0: java.time.temporal.TemporalAmount): java.time.chrono.ChronoZonedDateTime
      public with(arg0: java.time.temporal.TemporalField, arg1: long): java.time.chrono.ChronoZonedDateTime
      public with(arg0: java.time.temporal.TemporalAdjuster): java.time.chrono.ChronoZonedDateTime
