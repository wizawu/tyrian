  ...
  namespace time {
    namespace chrono {
      ...
      interface ChronoZonedDateTime<D extends java.time.chrono.ChronoLocalDate> extends java.time.temporal.Temporal, java.lang.Comparable<java.time.chrono.ChronoZonedDateTime<unknown>> {
        ...
        with(arg0: java.time.temporal.TemporalField, arg1: number | java.lang.Long): java.time.chrono.ChronoZonedDateTime<D>
        plus(arg0: java.time.temporal.TemporalAmount): java.time.chrono.ChronoZonedDateTime<D>
        plus(arg0: number | java.lang.Long, arg1: java.time.temporal.TemporalUnit): java.time.chrono.ChronoZonedDateTime<D>
        minus(arg0: java.time.temporal.TemporalAmount): java.time.chrono.ChronoZonedDateTime<D>
        minus(arg0: number | java.lang.Long, arg1: java.time.temporal.TemporalUnit): java.time.chrono.ChronoZonedDateTime<D>
