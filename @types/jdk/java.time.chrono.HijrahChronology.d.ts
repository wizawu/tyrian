  ...
  namespace time {
    namespace chrono {
      ...
      class HijrahChronology extends java.time.chrono.AbstractChronology implements java.io.Serializable {
        ...
        checkValidYear(arg0: long): int
        checkValidDayOfYear(arg0: int): void
        checkValidMonth(arg0: int): void
        getHijrahDateInfo(arg0: int): int[]
        getEpochDay(arg0: int, arg1: int, arg2: int): long
        getDayOfYear(arg0: int, arg1: int): int
        getMonthLength(arg0: int, arg1: int): int
        getYearLength(arg0: int): int
        getMinimumYear(): int
        getMaximumYear(): int
        getMaximumMonthLength(): int
        getMinimumMonthLength(): int
        getMaximumDayOfYear(): int
        getSmallestMaximumDayOfYear(): int
