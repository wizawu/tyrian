  ...
  namespace time {
    namespace format {
      class DateTimeFormatter {
        ...
        public static ofLocalizedDateTime(
        ...
        constructor(
          arg0: java.time.format.DateTimeFormatterBuilder$CompositePrinterParser,
          arg1: java.util.Locale,
          arg2: java.time.format.DecimalStyle,
          arg3: java.time.format.ResolverStyle,
          arg4: java.util.Set<java.time.temporal.TemporalField>,
          arg5: java.time.chrono.Chronology,
          arg6: java.time.ZoneId
        )
        ...
        public withResolverFields(
          arg0: java.util.Set<java.time.temporal.TemporalField>
        ): java.time.format.DateTimeFormatter
        ...
        public parse<T>(
          arg0: string | java.lang.CharSequence,
          arg1: java.time.temporal.TemporalQuery<T> | java.time.temporal.TemporalQuery$$lambda<T>
        ): T
        public parseBest(
          arg0: string | java.lang.CharSequence,
          ...vargs: (java.time.temporal.TemporalQuery<unknown> | java.time.temporal.TemporalQuery$$lambda<unknown>)[]
        ): java.time.temporal.TemporalAccessor
        public parseUnresolved(
          arg0: string | java.lang.CharSequence,
          arg1: java.text.ParsePosition
        ): java.time.temporal.TemporalAccessor
        toPrinterParser(
        ...
        public toFormat(
          arg0: java.time.temporal.TemporalQuery<unknown> | java.time.temporal.TemporalQuery$$lambda<unknown>
        ): java.text.Format
