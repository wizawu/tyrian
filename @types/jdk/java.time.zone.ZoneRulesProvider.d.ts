  ...
  namespace time {
    namespace zone {
      ...
      abstract class ZoneRulesProvider {
        ...
        protected abstract provideRules(arg0: java.lang.String, arg1: boolean): java.time.zone.ZoneRules
        protected abstract provideVersions(arg0: java.lang.String): java.util.NavigableMap<java.lang.String,java.time.zone.ZoneRules>
