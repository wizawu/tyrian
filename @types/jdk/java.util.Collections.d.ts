declare namespace java {
  namespace util {
    class Collections {
      ...
      static synchronizedCollection<T>(
      ...
      public static checkedCollection<E>(
        arg0: java.util.Collection<E>,
      ...
      public static checkedNavigableSet<E>(
        arg0: java.util.NavigableSet<E>,
        arg1: java.lang.Class<E>
      ): java.util.NavigableSet<E>
      public static checkedList<E>(arg0: java.util.List<E>, arg1: java.lang.Class<E>): java.util.List<E>
      public static checkedMap<K, V>(
        arg0: java.util.Map<K, V>,
        arg1: java.lang.Class<K>,
        arg2: java.lang.Class<V>
      ): java.util.Map<K, V>
      public static checkedSortedMap<K, V>(
        arg0: java.util.SortedMap<K, V>,
        arg1: java.lang.Class<K>,
        arg2: java.lang.Class<V>
      ): java.util.SortedMap<K, V>
      public static checkedNavigableMap<K, V>(
