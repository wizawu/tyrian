declare namespace java {
  namespace util {
    ...
    interface Comparator<T> {
      ...
      thenComparingInt(arg0: java.util.function$.ToIntFunction<unknown> | java.util.function$.ToIntFunction$$lambda<unknown>): java.util.Comparator<T>
      thenComparingLong(arg0: java.util.function$.ToLongFunction<unknown> | java.util.function$.ToLongFunction$$lambda<unknown>): java.util.Comparator<T>
      thenComparingDouble(arg0: java.util.function$.ToDoubleFunction<unknown> | java.util.function$.ToDoubleFunction$$lambda<unknown>): java.util.Comparator<T>
      ...
      comparingInt<T>(arg0: java.util.function$.ToIntFunction<unknown> | java.util.function$.ToIntFunction$$lambda<unknown>): java.util.Comparator<T>
      comparingLong<T>(arg0: java.util.function$.ToLongFunction<unknown> | java.util.function$.ToLongFunction$$lambda<unknown>): java.util.Comparator<T>
      comparingDouble<T>(arg0: java.util.function$.ToDoubleFunction<unknown> | java.util.function$.ToDoubleFunction$$lambda<unknown>): java.util.Comparator<T>
    }
