declare namespace java {
  namespace util {
    class Spliterators {
      ...
      public static spliterator<T>(
        arg0: java.util.Iterator<T>,
        arg1: number | java.lang.Long,
        arg2: number | java.lang.Integer
      ): java.util.Spliterator<T>
      public static spliteratorUnknownSize<T>(
        arg0: java.util.Iterator<T>,
        arg1: number | java.lang.Integer
      ): java.util.Spliterator<T>
      public static spliterator(
        arg0: java.util.PrimitiveIterator$OfInt,
        arg1: number | java.lang.Long,
        arg2: number | java.lang.Integer
      ): java.util.Spliterator$OfInt
      public static spliteratorUnknownSize(
        arg0: java.util.PrimitiveIterator$OfInt,
        arg1: number | java.lang.Integer
      ): java.util.Spliterator$OfInt
      public static spliterator(
        arg0: java.util.PrimitiveIterator$OfLong,
        arg1: number | java.lang.Long,
        arg2: number | java.lang.Integer
      ): java.util.Spliterator$OfLong
      public static spliteratorUnknownSize(
      ...
      public static spliterator(
        arg0: java.util.PrimitiveIterator$OfDouble,
        arg1: number | java.lang.Long,
        arg2: number | java.lang.Integer
      ): java.util.Spliterator$OfDouble
      public static spliteratorUnknownSize(
