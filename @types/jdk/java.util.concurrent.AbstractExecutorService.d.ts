  ...
  namespace util {
    namespace concurrent {
      ...
      abstract class AbstractExecutorService implements java.util.concurrent.ExecutorService {
        ...
        public invokeAny<T>(arg0: java.util.Collection<java.util.concurrent.Callable<T>>, arg1: number | java.lang.Long, arg2: java.util.concurrent.TimeUnit): T
        ...
        public invokeAll<T>(arg0: java.util.Collection<java.util.concurrent.Callable<T>>, arg1: number | java.lang.Long, arg2: java.util.concurrent.TimeUnit): java.util.List<java.util.concurrent.Future<T>>
      }
