  ...
  namespace util {
    namespace concurrent {
      ...
      interface ExecutorService extends java.util.concurrent.Executor {
        ...
        submit<T>(arg0: java.util.concurrent.Callable<T>): java.util.concurrent.Future<T>
        submit<T>(arg0: java.lang.Runnable, arg1: T): java.util.concurrent.Future<T>
        submit(arg0: java.lang.Runnable): java.util.concurrent.Future<unknown>
