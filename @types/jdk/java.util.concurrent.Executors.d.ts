  ...
  namespace util {
    namespace concurrent {
      ...
      class Executors {
        ...
        public static newFixedThreadPool(arg0: number | java.lang.Integer, arg1: java.util.concurrent.ThreadFactory | java.util.concurrent.ThreadFactory$$lambda): java.util.concurrent.ExecutorService
        ...
        public static newScheduledThreadPool(arg0: number | java.lang.Integer): java.util.concurrent.ScheduledExecutorService
        public static newScheduledThreadPool(arg0: number | java.lang.Integer, arg1: java.util.concurrent.ThreadFactory | java.util.concurrent.ThreadFactory$$lambda): java.util.concurrent.ScheduledExecutorService
        ...
        public static callable(arg0: java.security.PrivilegedAction<unknown> | java.security.PrivilegedAction$$lambda<unknown>): java.util.concurrent.Callable<java.lang.Object>
        public static callable(arg0: java.security.PrivilegedExceptionAction<unknown> | java.security.PrivilegedExceptionAction$$lambda<unknown>): java.util.concurrent.Callable<java.lang.Object>
