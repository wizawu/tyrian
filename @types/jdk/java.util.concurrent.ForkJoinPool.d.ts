  ...
  namespace util {
    namespace concurrent {
      class ForkJoinPool extends java.util.concurrent.AbstractExecutorService {
        ...
        awaitJoin(
          arg0: java.util.concurrent.ForkJoinPool$WorkQueue,
        ...
        externalHelpComplete(
          arg0: java.util.concurrent.CountedCompleter<unknown>,
        ...
        public constructor(
          ...
          arg1:
            ...
            | java.util.concurrent.ForkJoinPool$ForkJoinWorkerThreadFactory$$lambda,
          arg2: java.lang.Thread$UncaughtExceptionHandler | java.lang.Thread$UncaughtExceptionHandler$$lambda,
        ...
        public constructor(
          ...
          arg7: java.util.function$.Predicate<unknown>,
          arg8: number | java.lang.Long,
        ...
        static helpAsyncBlocker(
          arg0: java.util.concurrent.Executor | java.util.concurrent.Executor$$lambda,
          arg1: java.util.concurrent.ForkJoinPool$ManagedBlocker
        ): void
        ...
        public submit(
          arg0: java.util.concurrent.Callable | java.util.concurrent.Callable$$lambda
