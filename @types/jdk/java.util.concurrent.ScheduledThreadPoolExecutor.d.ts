  ...
  namespace util {
    namespace concurrent {
      ...
      class ScheduledThreadPoolExecutor extends java.util.concurrent.ThreadPoolExecutor implements java.util.concurrent.ScheduledExecutorService {
        ...
        public constructor(arg0: number | java.lang.Integer, arg1: java.util.concurrent.ThreadFactory | java.util.concurrent.ThreadFactory$$lambda)
        public constructor(arg0: number | java.lang.Integer, arg1: java.util.concurrent.RejectedExecutionHandler | java.util.concurrent.RejectedExecutionHandler$$lambda)
        public constructor(arg0: number | java.lang.Integer, arg1: java.util.concurrent.ThreadFactory | java.util.concurrent.ThreadFactory$$lambda, arg2: java.util.concurrent.RejectedExecutionHandler | java.util.concurrent.RejectedExecutionHandler$$lambda)
        triggerTime(arg0: number | java.lang.Long): number
        public schedule(arg0: java.lang.Runnable | java.lang.Runnable$$lambda, arg1: number | java.lang.Long, arg2: java.util.concurrent.TimeUnit): java.util.concurrent.ScheduledFuture<unknown>
        public schedule<V>(arg0: java.util.concurrent.Callable<V> | java.util.concurrent.Callable$$lambda<V>, arg1: number | java.lang.Long, arg2: java.util.concurrent.TimeUnit): java.util.concurrent.ScheduledFuture<V>
        public scheduleAtFixedRate(arg0: java.lang.Runnable | java.lang.Runnable$$lambda, arg1: number | java.lang.Long, arg2: number | java.lang.Long, arg3: java.util.concurrent.TimeUnit): java.util.concurrent.ScheduledFuture<unknown>
        public scheduleWithFixedDelay(arg0: java.lang.Runnable | java.lang.Runnable$$lambda, arg1: number | java.lang.Long, arg2: number | java.lang.Long, arg3: java.util.concurrent.TimeUnit): java.util.concurrent.ScheduledFuture<unknown>
