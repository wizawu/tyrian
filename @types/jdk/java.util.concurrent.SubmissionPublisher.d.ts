  ...
  namespace util {
    namespace concurrent {
      class SubmissionPublisher<T> implements java.util.concurrent.Flow$Publisher<T>, java.lang.AutoCloseable {
        ...
        public offer(
          arg0: T,
          arg1: java.util.function$.BiPredicate<java.util.concurrent.Flow$Subscriber<unknown>, unknown>
        ): number
        public offer(
          arg0: T,
          arg1: number | java.lang.Long,
          arg2: java.util.concurrent.TimeUnit,
          arg3: java.util.function$.BiPredicate<java.util.concurrent.Flow$Subscriber<unknown>, unknown>
        ): number
        public close(): void
