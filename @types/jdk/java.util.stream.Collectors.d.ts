  ...
  namespace util {
    namespace stream {
      ...
      class Collectors {
        ...
        public static toCollection<T,C extends java.util.Collection<T>>(arg0: java.util.function$.Supplier<C>): java.util.stream.Collector<T,unknown,C>
        ...
        public static summingInt<T>(arg0: java.util.function$.ToIntFunction<unknown>): java.util.stream.Collector<T,unknown,java.lang.Integer>
        public static summingLong<T>(arg0: java.util.function$.ToLongFunction<unknown>): java.util.stream.Collector<T,unknown,java.lang.Long>
        public static summingDouble<T>(arg0: java.util.function$.ToDoubleFunction<unknown>): java.util.stream.Collector<T,unknown,java.lang.Double>
        static sumWithCompensation(arg0: double[], arg1: double): double[]
        static computeFinalSum(arg0: double[]): double
        public static averagingInt<T>(arg0: java.util.function$.ToIntFunction<unknown>): java.util.stream.Collector<T,unknown,java.lang.Double>
        public static averagingLong<T>(arg0: java.util.function$.ToLongFunction<unknown>): java.util.stream.Collector<T,unknown,java.lang.Double>
        public static averagingDouble<T>(arg0: java.util.function$.ToDoubleFunction<unknown>): java.util.stream.Collector<T,unknown,java.lang.Double>
        ...
        public static groupingBy<T,K,D,A,M extends java.util.Map<K,D>>(arg0: java.util.function$.Function<unknown,K>, arg1: java.util.function$.Supplier<M>, arg2: java.util.stream.Collector<unknown,A,D>): java.util.stream.Collector<T,unknown,M>
        ...
        public static groupingByConcurrent<T,K,A,D,M extends java.util.concurrent.ConcurrentMap<K,D>>(arg0: java.util.function$.Function<unknown,K>, arg1: java.util.function$.Supplier<M>, arg2: java.util.stream.Collector<unknown,A,D>): java.util.stream.Collector<T,unknown,M>
        ...
        public static toMap<T,K,U,M extends java.util.Map<K,U>>(arg0: java.util.function$.Function<unknown,K>, arg1: java.util.function$.Function<unknown,U>, arg2: java.util.function$.BinaryOperator<U>, arg3: java.util.function$.Supplier<M>): java.util.stream.Collector<T,unknown,M>
        ...
        public static toConcurrentMap<T,K,U,M extends java.util.concurrent.ConcurrentMap<K,U>>(arg0: java.util.function$.Function<unknown,K>, arg1: java.util.function$.Function<unknown,U>, arg2: java.util.function$.BinaryOperator<U>, arg3: java.util.function$.Supplier<M>): java.util.stream.Collector<T,unknown,M>
        public static summarizingInt<T>(arg0: java.util.function$.ToIntFunction<unknown>): java.util.stream.Collector<T,unknown,java.util.IntSummaryStatistics>
        public static summarizingLong<T>(arg0: java.util.function$.ToLongFunction<unknown>): java.util.stream.Collector<T,unknown,java.util.LongSummaryStatistics>
        public static summarizingDouble<T>(arg0: java.util.function$.ToDoubleFunction<unknown>): java.util.stream.Collector<T,unknown,java.util.DoubleSummaryStatistics>
      }
