  ...
  namespace util {
    namespace stream {
      ...
      interface DoubleStream extends java.util.stream.BaseStream<java.lang.Double,java.util.stream.DoubleStream> {
        ...
        toArray(): number[]
        reduce(arg0: number | java.lang.Double, arg1: java.util.function$.DoubleBinaryOperator | java.util.function$.DoubleBinaryOperator$$lambda): number
        ...
        iterate(arg0: number | java.lang.Double, arg1: java.util.function$.DoubleUnaryOperator): java.util.stream.DoubleStream
        iterate(arg0: number | java.lang.Double, arg1: java.util.function$.DoublePredicate, arg2: java.util.function$.DoubleUnaryOperator): java.util.stream.DoubleStream
