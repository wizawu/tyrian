  ...
  namespace util {
    namespace stream {
      ...
      interface DoubleStream extends java.util.stream.BaseStream<java.lang.Double,java.util.stream.DoubleStream> {
        ...
        mapToObj<U>(arg0: java.util.function$.DoubleFunction<U>): java.util.stream.Stream<U>
        ...
        iterate(arg0: double, arg1: java.util.function$.DoublePredicate, arg2: java.util.function$.DoubleUnaryOperator): java.util.stream.DoubleStream
