  ...
  namespace util {
    namespace stream {
      ...
      interface IntStream extends java.util.stream.BaseStream<java.lang.Integer,java.util.stream.IntStream> {
        ...
        toArray(): number[]
        reduce(arg0: number | java.lang.Integer, arg1: java.util.function$.IntBinaryOperator | java.util.function$.IntBinaryOperator$$lambda): number
        ...
        iterate(arg0: number | java.lang.Integer, arg1: java.util.function$.IntUnaryOperator): java.util.stream.IntStream
        iterate(arg0: number | java.lang.Integer, arg1: java.util.function$.IntPredicate, arg2: java.util.function$.IntUnaryOperator): java.util.stream.IntStream
