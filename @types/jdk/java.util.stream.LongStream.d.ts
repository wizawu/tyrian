  ...
  namespace util {
    namespace stream {
      interface LongStream extends java.util.stream.BaseStream<java.lang.Long, java.util.stream.LongStream> {
        ...
        mapToObj<U>(
          arg0: java.util.function$.LongFunction<U> | java.util.function$.LongFunction$$lambda<U>
        ): java.util.stream.Stream<U>
        mapToInt(
          arg0: java.util.function$.LongToIntFunction | java.util.function$.LongToIntFunction$$lambda
        ): java.util.stream.IntStream
        mapToDouble(
          arg0: java.util.function$.LongToDoubleFunction | java.util.function$.LongToDoubleFunction$$lambda
        ): java.util.stream.DoubleStream
        flatMap(
          arg0:
            | java.util.function$.LongFunction<java.util.stream.LongStream>
            | java.util.function$.LongFunction$$lambda<java.util.stream.LongStream>
        ...
        collect<R>(
          ...
          arg1: java.util.function$.ObjLongConsumer<R> | java.util.function$.ObjLongConsumer$$lambda<R>,
