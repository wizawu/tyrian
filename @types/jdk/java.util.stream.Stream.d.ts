  ...
  namespace util {
    namespace stream {
      ...
      interface Stream<T> extends java.util.stream.BaseStream<T,java.util.stream.Stream<T>> {
        ...
        mapToInt(arg0: java.util.function$.ToIntFunction<unknown>): java.util.stream.IntStream
        mapToLong(arg0: java.util.function$.ToLongFunction<unknown>): java.util.stream.LongStream
        mapToDouble(arg0: java.util.function$.ToDoubleFunction<unknown>): java.util.stream.DoubleStream
        ...
        collect<R>(arg0: java.util.function$.Supplier<R>, arg1: java.util.function$.BiConsumer<R,unknown>, arg2: java.util.function$.BiConsumer<R,R>): R
        ...
        generate<T>(arg0: java.util.function$.Supplier<T>): java.util.stream.Stream<T>
