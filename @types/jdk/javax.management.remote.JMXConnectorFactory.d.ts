    ...
    namespace remote {
      class JMXConnectorFactory {
        ...
        static getProvider<T>(
          ...
          arg4: java.lang.ClassLoader
        ): T
        static isSystemProvider(arg0: java.util.ServiceLoader$Provider<unknown>): boolean
        static getConnectorAsService<P, C>(
          arg0: java.lang.Class<P>,
          arg1: java.lang.ClassLoader,
          arg2: javax.management.remote.JMXServiceURL,
          arg3: java.util.function$.Predicate<java.util.ServiceLoader$Provider<unknown>>,
          arg4: javax.management.remote.JMXConnectorFactory$ConnectorFactory<P, C>
        ): C
        static getProvider<T>(
