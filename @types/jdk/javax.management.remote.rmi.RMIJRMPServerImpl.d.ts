    ...
    namespace remote {
      namespace rmi {
        ...
        class RMIJRMPServerImpl extends javax.management.remote.rmi.RMIServerImpl {
          public constructor(arg0: number | java.lang.Integer, arg1: java.rmi.server.RMIClientSocketFactory | java.rmi.server.RMIClientSocketFactory$$lambda, arg2: java.rmi.server.RMIServerSocketFactory | java.rmi.server.RMIServerSocketFactory$$lambda, arg3: java.util.Map<java.lang.String,unknown>)
