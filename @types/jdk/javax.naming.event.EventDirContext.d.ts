    ...
    namespace event {
      interface EventDirContext extends javax.naming.event.EventContext, javax.naming.directory.DirContext {
        addNamingListener(
          ...
          arg3: javax.naming.event.NamingListener | javax.naming.event.NamingListener$$lambda
        ): void
        addNamingListener(
        ...
        addNamingListener(
          ...
          arg4: javax.naming.event.NamingListener | javax.naming.event.NamingListener$$lambda
        ): void
        addNamingListener(
          arg0: java.lang.String | string,
          arg1: java.lang.String | string,
