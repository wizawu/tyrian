  ...
  namespace rmi {
    namespace ssl {
      ...
      class SslRMIServerSocketFactory implements java.rmi.server.RMIServerSocketFactory {
        public constructor()
        public constructor(arg0: java.lang.String[], arg1: java.lang.String[], arg2: boolean | java.lang.Boolean)
        public constructor(arg0: javax.net.ssl.SSLContext, arg1: java.lang.String[], arg2: java.lang.String[], arg3: boolean | java.lang.Boolean)
