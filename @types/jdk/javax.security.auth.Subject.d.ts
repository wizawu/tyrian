    ...
    namespace auth {
      class Subject implements java.io.Serializable {
        ...
        public constructor(
          ...
          arg1: java.util.Set<java.security.Principal>,
          arg2: java.util.Set<unknown>,
          arg3: java.util.Set<unknown>
        )
        public setReadOnly(): void
        public isReadOnly(): boolean
        public static getSubject(arg0: java.security.AccessControlContext): javax.security.auth.Subject
        public static doAs<T>(
          arg0: javax.security.auth.Subject,
          arg1: java.security.PrivilegedAction<T> | java.security.PrivilegedAction$$lambda<T>
        ): T
        public static doAs<T>(
          arg0: javax.security.auth.Subject,
          arg1: java.security.PrivilegedExceptionAction<T> | java.security.PrivilegedExceptionAction$$lambda<T>
        ): T
        public static doAsPrivileged<T>(
          arg0: javax.security.auth.Subject,
          arg1: java.security.PrivilegedAction<T> | java.security.PrivilegedAction$$lambda<T>,
