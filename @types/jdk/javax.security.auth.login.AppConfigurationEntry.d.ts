    ...
    namespace auth {
      namespace login {
        ...
        class AppConfigurationEntry {
          public constructor(arg0: java.lang.String, arg1: javax.security.auth.login.AppConfigurationEntry$LoginModuleControlFlag, arg2: java.util.Map<java.lang.String,unknown>)
