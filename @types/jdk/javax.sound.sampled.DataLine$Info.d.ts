  ...
  namespace sound {
    namespace sampled {
      ...
      class DataLine$Info extends javax.sound.sampled.Line$Info {
        public constructor(arg0: java.lang.Class<unknown>, arg1: javax.sound.sampled.AudioFormat[], arg2: int, arg3: int)
        public constructor(arg0: java.lang.Class<unknown>, arg1: javax.sound.sampled.AudioFormat, arg2: int)
