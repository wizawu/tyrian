    ...
    namespace rowset {
      namespace spi {
        ...
        class SyncFactory {
          ...
          public static registerProvider(arg0: java.lang.String): void
          public static getSyncFactory(): javax.sql.rowset.spi.SyncFactory
          public static unregisterProvider(arg0: java.lang.String): void
          public static getInstance(arg0: java.lang.String): javax.sql.rowset.spi.SyncProvider
