    ...
    namespace plaf {
      namespace metal {
        ...
        class MetalTreeUI extends javax.swing.plaf.basic.BasicTreeUI {
          ...
          protected isLocationInExpandControl(arg0: number | java.lang.Integer, arg1: number | java.lang.Integer, arg2: number | java.lang.Integer, arg3: number | java.lang.Integer): boolean
