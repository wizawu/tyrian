declare namespace jdk {
  namespace dynalink {
    class DynamicLinkerFactory {
      ...
      public setPrioritizedLinkers(
        ...vargs: (jdk.dynalink.linker.GuardingDynamicLinker | jdk.dynalink.linker.GuardingDynamicLinker$$lambda)[]
      ): void
      public setPrioritizedLinker(
        arg0: jdk.dynalink.linker.GuardingDynamicLinker | jdk.dynalink.linker.GuardingDynamicLinker$$lambda
      ): void
      public setFallbackLinkers(arg0: java.util.List<jdk.dynalink.linker.GuardingDynamicLinker>): void
      public setFallbackLinkers(
        ...vargs: (jdk.dynalink.linker.GuardingDynamicLinker | jdk.dynalink.linker.GuardingDynamicLinker$$lambda)[]
      ): void
      ...
      public setPrelinkTransformer(
        arg0:
          | jdk.dynalink.linker.GuardedInvocationTransformer
          | jdk.dynalink.linker.GuardedInvocationTransformer$$lambda
      ): void
      public setAutoConversionStrategy(
        arg0:
          | jdk.dynalink.linker.MethodTypeConversionStrategy
          | jdk.dynalink.linker.MethodTypeConversionStrategy$$lambda
      ): void
      public setInternalObjectsFilter(
        arg0: jdk.dynalink.linker.MethodHandleTransformer | jdk.dynalink.linker.MethodHandleTransformer$$lambda
      ): void
