  ...
  namespace dynalink {
    namespace beans {
      ...
      class BeansLinker implements jdk.dynalink.linker.GuardingDynamicLinker {
        public constructor()
        public constructor(arg0: jdk.dynalink.beans.MissingMemberHandlerFactory)
        ...
        public static getConstructorMethod(arg0: java.lang.Class<unknown>, arg1: java.lang.String): java.lang.Object
