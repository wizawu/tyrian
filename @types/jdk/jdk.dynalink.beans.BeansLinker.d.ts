  ...
  namespace dynalink {
    namespace beans {
      class BeansLinker implements jdk.dynalink.linker.GuardingDynamicLinker {
        public constructor()
        public constructor(
          arg0: jdk.dynalink.beans.MissingMemberHandlerFactory | jdk.dynalink.beans.MissingMemberHandlerFactory$$lambda
        )
        public getLinkerForClass(arg0: java.lang.Class<unknown>): jdk.dynalink.linker.TypeBasedGuardingDynamicLinker
        static getStaticLinkerForClass(
        ...
        public static getConstructorMethod(
          arg0: java.lang.Class<unknown>,
