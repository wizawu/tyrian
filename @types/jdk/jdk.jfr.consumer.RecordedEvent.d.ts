  ...
  namespace jfr {
    namespace consumer {
      ...
      class RecordedEvent extends jdk.jfr.consumer.RecordedObject {
        ...
        constructor(arg0: jdk.jfr.EventType, arg1: java.util.List<jdk.jfr.ValueDescriptor>, arg2: java.lang.Object[], arg3: number | java.lang.Long, arg4: number | java.lang.Long, arg5: jdk.jfr.consumer.TimeConverter)
