  ...
  namespace jshell {
    namespace execution {
      ...
      class Util {
        ...
        public static detectJdiExitEvent(arg0: com.sun.jdi.VirtualMachine, arg1: java.util.function$.Consumer<java.lang.String> | java.util.function$.Consumer$$lambda<java.lang.String>): void
      }
