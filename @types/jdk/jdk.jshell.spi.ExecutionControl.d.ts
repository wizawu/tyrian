  ...
  namespace jshell {
    namespace spi {
      ...
      interface ExecutionControl extends java.lang.AutoCloseable {
        ...
        close(): void
        generate(arg0: jdk.jshell.spi.ExecutionEnv, arg1: java.lang.String | string, arg2: java.util.Map<java.lang.String,java.lang.String>): jdk.jshell.spi.ExecutionControl
