        ...
        namespace internal {
            namespace ir {
                abstract class JumpStatement extends jdk.nashorn.internal.ir.Statement implements jdk.nashorn.internal.ir.JoinPredecessor {
                    ...
                    protected constructor(arg0: jdk.nashorn.internal.ir.JumpStatement | jdk.nashorn.internal.ir.JumpStatement$$Lambda, arg1: jdk.nashorn.internal.ir.LocalVariableConversion)
                    public hasGoto(): boolean
                    public getLabelName(): string
                    public toString(arg0: java.lang.StringBuilder, arg1: boolean): void
                    public abstract getTarget(arg0: jdk.nashorn.internal.ir.LexicalContext): jdk.nashorn.internal.ir.BreakableNode
                ...
                interface JumpStatement$$Lambda extends jdk.nashorn.internal.ir.Statement implements jdk.nashorn.internal.ir.JoinPredecessor {
                    (arg0: jdk.nashorn.internal.ir.LexicalContext): jdk.nashorn.internal.ir.BreakableNode
                }
            }
        }
    }
