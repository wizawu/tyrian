declare namespace com {
    namespace ibm {
        namespace dataaccess {
            class CommonData {
                public static readonly HIGHER_NIBBLE_MASK: int
                public static readonly LOWER_NIBBLE_MASK: int
                public static readonly INTEGER_MASK: int
                protected static readonly EXTERNAL_SIGN_PLUS: byte
                protected static readonly EXTERNAL_SIGN_MINUS: byte
                protected static readonly EXTERNAL_EMBEDDED_SIGN_PLUS: byte
                protected static readonly EXTERNAL_EMBEDDED_SIGN_MINUS: byte
                protected static readonly EXTERNAL_EMBEDDED_SIGN_PLUS_ALTERNATE_A: byte
                protected static readonly EXTERNAL_EMBEDDED_SIGN_PLUS_ALTERNATE_E: byte
                protected static readonly EXTERNAL_EMBEDDED_SIGN_PLUS_ALTERNATE_F: byte
                protected static readonly EXTERNAL_EMBEDDED_SIGN_MINUS_ALTERNATE_B: byte
                protected static readonly PACKED_INVALID_DIGIT: byte
