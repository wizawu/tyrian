                ...
                namespace api {
                    namespace message {
                        abstract class BasePropertySet implements com.oracle.webservices.internal.api.message.PropertySet {
                            ...
                            protected abstract getPropertyMap(): com.oracle.webservices.internal.api.message.BasePropertySet$PropertyMap
                        ...
                        interface BasePropertySet$$Lambda implements com.oracle.webservices.internal.api.message.PropertySet {
                            (): com.oracle.webservices.internal.api.message.BasePropertySet$PropertyMap
                        }
                    }
                }
            }
