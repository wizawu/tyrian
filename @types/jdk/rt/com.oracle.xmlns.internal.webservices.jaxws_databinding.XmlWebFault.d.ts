...
class XmlWebFault implements javax.xml.ws.WebFault {
    protected name: string
    protected targetNamespace: string
    protected faultBean: string
    ...
    public getFaultBean(): string
    public setFaultBean(arg0: java.lang.String | string): void
    public name(): string
    public targetNamespace(): string
    public faultBean(): string
