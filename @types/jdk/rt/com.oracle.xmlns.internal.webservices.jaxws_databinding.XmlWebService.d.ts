            ...
            namespace internal {
                namespace webservices {
                    namespace jaxws_databinding {
                        class XmlWebService implements javax.jws.WebService {
                            protected endpointInterface: string
                            ...
                            public constructor()
                            public getEndpointInterface(): string
                            public setEndpointInterface(arg0: java.lang.String | string): void
                            ...
                            public endpointInterface(): string
