                ...
                namespace impl {
                    namespace ior {
                        abstract class ObjectKeyTemplateBase implements com.sun.corba.se.spi.ior.ObjectKeyTemplate {
                            public static readonly JIDL_ORB_ID: string
                            public static readonly JIDL_OAID: com.sun.corba.se.spi.ior.ObjectAdapterId
                            ...
                            protected abstract writeTemplate(arg0: org.omg.CORBA_2_3.portable.OutputStream): void
                        ...
                        interface ObjectKeyTemplateBase$$Lambda implements com.sun.corba.se.spi.ior.ObjectKeyTemplate {
