                    ...
                    namespace naming {
                        namespace pcosnaming {
                            class ServantManagerImpl extends org.omg.CORBA.LocalObject implements org.omg.PortableServer.ServantLocator {
                                ...
                                public postinvoke(arg0: byte[], arg1: org.omg.PortableServer.POA, arg2: java.lang.String | string, arg3: java.lang.Object, arg4: org.omg.PortableServer.Servant | org.omg.PortableServer.Servant$$Lambda): void
