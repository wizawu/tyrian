...
interface POAPolicyMediator {
    ...
    setDefaultServant(arg0: org.omg.PortableServer.Servant): void
    activateObject(arg0: byte[], arg1: org.omg.PortableServer.Servant): void
    deactivateObject(arg0: byte[]): org.omg.PortableServer.Servant
    newSystemId(): byte[]
    servantToId(arg0: org.omg.PortableServer.Servant): byte[]
