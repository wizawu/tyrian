    ...
    namespace sun {
        namespace corba {
            namespace se {
                namespace impl {
                    namespace protocol {
                        class JIDLLocalCRDImpl extends com.sun.corba.se.impl.protocol.LocalClientRequestDispatcherBase {
                            protected servant: org.omg.CORBA.portable.ServantObject
                            public constructor(arg0: com.sun.corba.se.spi.orb.ORB, arg1: int, arg2: com.sun.corba.se.spi.ior.IOR)
