                ...
                namespace impl {
                    namespace protocol {
                        namespace giopmsgheaders {
                            class FragmentMessage_1_1 extends com.sun.corba.se.impl.protocol.giopmsgheaders.Message_1_1 implements com.sun.corba.se.impl.protocol.giopmsgheaders.FragmentMessage {
                                public getRequestId(): int
                                public getHeaderLength(): int
