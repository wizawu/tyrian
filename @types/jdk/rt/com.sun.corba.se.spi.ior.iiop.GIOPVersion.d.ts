            ...
            namespace se {
                namespace spi {
                    namespace ior {
                        namespace iiop {
                            class GIOPVersion {
                                public static readonly V1_0: com.sun.corba.se.spi.ior.iiop.GIOPVersion
                                public static readonly V1_1: com.sun.corba.se.spi.ior.iiop.GIOPVersion
                                public static readonly V1_2: com.sun.corba.se.spi.ior.iiop.GIOPVersion
                                public static readonly V1_3: com.sun.corba.se.spi.ior.iiop.GIOPVersion
                                public static readonly V13_XX: com.sun.corba.se.spi.ior.iiop.GIOPVersion
                                public static readonly DEFAULT_VERSION: com.sun.corba.se.spi.ior.iiop.GIOPVersion
                                public static readonly VERSION_1_0: int
                                public static readonly VERSION_1_1: int
                                public static readonly VERSION_1_2: int
                                public static readonly VERSION_1_3: int
                                public static readonly VERSION_13_XX: int
                                public constructor()
