    ...
    namespace sun {
        namespace java {
            namespace swing {
                namespace plaf {
                    namespace motif {
                        class MotifCheckBoxMenuItemUI$MouseInputHandler implements javax.swing.event.MouseInputListener {
                            protected constructor(arg0: com.sun.java.swing.plaf.motif.MotifCheckBoxMenuItemUI)
