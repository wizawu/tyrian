    ...
    namespace sun {
        namespace java {
            namespace swing {
                namespace plaf {
                    namespace windows {
class WindowsLookAndFeel extends javax.swing.plaf.basic.BasicLookAndFeel {
    public constructor()
    ...
    public static setMnemonicHidden(arg0: boolean): void
    public static isMnemonicHidden(): boolean
    public static isClassicWindows(): boolean
