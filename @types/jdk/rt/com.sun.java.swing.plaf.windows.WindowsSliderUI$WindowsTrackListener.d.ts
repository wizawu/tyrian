    ...
    namespace sun {
        namespace java {
            namespace swing {
                namespace plaf {
                    namespace windows {
class WindowsSliderUI$WindowsTrackListener extends javax.swing.plaf.basic.BasicSliderUI$TrackListener {
    ...
    public updatePressed(arg0: boolean): void
    public updateRollover(arg0: boolean): void
