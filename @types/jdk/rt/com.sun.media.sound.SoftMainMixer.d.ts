        ...
        namespace media {
            namespace sound {
                class SoftMainMixer {
                    ...
                    public static readonly CHANNEL_MONO: int
                    public static readonly CHANNEL_DELAY_LEFT: int
                    public static readonly CHANNEL_DELAY_RIGHT: int
                    public static readonly CHANNEL_DELAY_MONO: int
                    public static readonly CHANNEL_EFFECT1: int
                    public static readonly CHANNEL_EFFECT2: int
                    public static readonly CHANNEL_DELAY_EFFECT1: int
                    public static readonly CHANNEL_DELAY_EFFECT2: int
                    ...
                    public processMessage(arg0: javax.sound.midi.MidiMessage | javax.sound.midi.MidiMessage$$Lambda): void
