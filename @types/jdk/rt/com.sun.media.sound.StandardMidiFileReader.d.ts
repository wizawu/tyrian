        ...
        namespace media {
            namespace sound {
                class StandardMidiFileReader extends javax.sound.midi.spi.MidiFileReader {
                    public constructor()
                    public getMidiFileFormat(arg0: java.io.InputStream | java.io.InputStream$$Lambda): javax.sound.midi.MidiFileFormat
                    ...
                    public getSequence(arg0: java.io.InputStream | java.io.InputStream$$Lambda): javax.sound.midi.Sequence
