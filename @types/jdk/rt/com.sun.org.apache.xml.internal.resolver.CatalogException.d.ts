...
class CatalogException extends java.lang.Exception {
    public static WRAPPER: int
    public static INVALID_ENTRY: int
    public static INVALID_ENTRY_TYPE: int
    public static NO_XML_PARSER: int
    public static UNKNOWN_FORMAT: int
    public static UNPARSEABLE: int
    public static PARSE_FAILED: int
    public static UNENDED_COMMENT: int
