                ...
                namespace xml {
                    namespace internal {
                        namespace security {
                            namespace utils {
                                class Base64 {
                                    public static readonly BASE64DEFAULTLENGTH: int
                                    ...
                                    public static decode(arg0: java.io.InputStream | java.io.InputStream$$Lambda, arg1: java.io.OutputStream | java.io.OutputStream$$Lambda): void
