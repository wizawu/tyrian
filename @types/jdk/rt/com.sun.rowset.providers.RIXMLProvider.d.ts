        ...
        namespace rowset {
            namespace providers {
                class RIXMLProvider extends javax.sql.rowset.spi.SyncProvider {
                    ...
                    public setXmlReader(arg0: javax.sql.rowset.spi.XmlReader | javax.sql.rowset.spi.XmlReader$$Lambda): void
                    public setXmlWriter(arg0: javax.sql.rowset.spi.XmlWriter | javax.sql.rowset.spi.XmlWriter$$Lambda): void
