            ...
            namespace internal {
                namespace bind {
                    namespace v2 {
                        namespace runtime {
                            namespace output {
                                class MTOMXmlOutput extends com.sun.xml.internal.bind.v2.runtime.output.XmlOutputAbstractImpl {
                                    public constructor(arg0: com.sun.xml.internal.bind.v2.runtime.output.XmlOutput)
