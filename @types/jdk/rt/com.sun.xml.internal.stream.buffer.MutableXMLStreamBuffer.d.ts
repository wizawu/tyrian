                ...
                namespace stream {
                    namespace buffer {
                        class MutableXMLStreamBuffer extends com.sun.xml.internal.stream.buffer.XMLStreamBuffer {
                            public static readonly DEFAULT_ARRAY_SIZE: int
                            public constructor()
                            ...
                            public createFromXMLReader(arg0: org.xml.sax.XMLReader, arg1: java.io.InputStream | java.io.InputStream$$Lambda): void
                            public createFromXMLReader(arg0: org.xml.sax.XMLReader, arg1: java.io.InputStream | java.io.InputStream$$Lambda, arg2: java.lang.String | string): void
                            public reset(): void
