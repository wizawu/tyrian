                ...
                namespace ws {
                    namespace addressing {
                        class WsaPropertyBag extends com.oracle.webservices.internal.api.message.BasePropertySet {
                            public static readonly WSA_REPLYTO_FROM_REQUEST: string
                            public static readonly WSA_FAULTTO_FROM_REQUEST: string
                            public static readonly WSA_MSGID_FROM_REQUEST: string
                            public static readonly WSA_TO: string
