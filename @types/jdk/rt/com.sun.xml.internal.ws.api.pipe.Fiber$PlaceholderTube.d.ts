        ...
        namespace xml {
            namespace internal {
                namespace ws {
                    namespace api {
                        namespace pipe {
                            class Fiber$PlaceholderTube extends com.sun.xml.internal.ws.api.pipe.helper.AbstractTubeImpl {
                                ...
                                public copy(arg0: com.sun.xml.internal.ws.api.pipe.TubeCloner): com.sun.xml.internal.ws.api.pipe.Fiber$PlaceholderTube
