                    ...
                    namespace api {
                        namespace streaming {
                            abstract class XMLStreamWriterFactory {
                                public constructor()
                                public abstract doCreate(arg0: java.io.OutputStream | java.io.OutputStream$$Lambda): javax.xml.stream.XMLStreamWriter
                                public abstract doCreate(arg0: java.io.OutputStream | java.io.OutputStream$$Lambda, arg1: java.lang.String | string): javax.xml.stream.XMLStreamWriter
                                public abstract doRecycle(arg0: javax.xml.stream.XMLStreamWriter): void
