    ...
    namespace sun {
        namespace xml {
            namespace internal {
                namespace ws {
                    namespace handler {
                        class LogicalMessageImpl$EmptyLogicalMessageImpl extends com.sun.xml.internal.ws.handler.LogicalMessageImpl$ImmutableLM {
                            public constructor(arg0: com.sun.xml.internal.ws.handler.LogicalMessageImpl)
