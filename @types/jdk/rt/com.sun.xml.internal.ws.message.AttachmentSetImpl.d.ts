    ...
    namespace sun {
        namespace xml {
            namespace internal {
                namespace ws {
                    namespace message {
                        class AttachmentSetImpl implements com.sun.xml.internal.ws.api.message.AttachmentSet {
                            public constructor()
                            public constructor(arg0: java.lang.Iterable<com.sun.xml.internal.ws.api.message.Attachment>)
