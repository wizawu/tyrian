        ...
        namespace xml {
            namespace internal {
                namespace ws {
                    namespace message {
                        namespace stream {
class OutboundStreamHeader extends com.sun.xml.internal.ws.message.AbstractHeaderImpl {
    public constructor(arg0: com.sun.xml.internal.stream.buffer.XMLStreamBuffer, arg1: java.lang.String | string, arg2: java.lang.String | string)
