        ...
        namespace xml {
            namespace internal {
                namespace ws {
                    namespace message {
                        namespace stream {
                            class StreamHeader11 extends com.sun.xml.internal.ws.message.stream.StreamHeader {
                                protected static readonly SOAP_1_1_MUST_UNDERSTAND: string
                                protected static readonly SOAP_1_1_ROLE: string
