                    ...
                    namespace transport {
                        namespace http {
                            class HttpAdapter extends com.sun.xml.internal.ws.api.server.Adapter<com.sun.xml.internal.ws.transport.http.HttpAdapter$HttpToolkit> {
                                ...
                                public readonly owner: com.sun.xml.internal.ws.transport.http.HttpAdapterList<com.sun.xml.internal.ws.transport.http.HttpAdapter>
                                public readonly urlPattern: string
                                protected stickyCookie: boolean
                                protected disableJreplicaCookie: boolean
                                public static readonly NO_OP_COMPLETION_CALLBACK: com.sun.xml.internal.ws.transport.http.HttpAdapter$CompletionCallback
                                ...
                                protected constructor(arg0: com.sun.xml.internal.ws.api.server.WSEndpoint, arg1: com.sun.xml.internal.ws.transport.http.HttpAdapterList<com.sun.xml.internal.ws.transport.http.HttpAdapter> | com.sun.xml.internal.ws.transport.http.HttpAdapterList$$Lambda<com.sun.xml.internal.ws.transport.http.HttpAdapter>)
                                protected constructor(arg0: com.sun.xml.internal.ws.api.server.WSEndpoint, arg1: com.sun.xml.internal.ws.transport.http.HttpAdapterList<com.sun.xml.internal.ws.transport.http.HttpAdapter> | com.sun.xml.internal.ws.transport.http.HttpAdapterList$$Lambda<com.sun.xml.internal.ws.transport.http.HttpAdapter>, arg2: java.lang.String | string)
                                ...
                                protected writeClientError(arg0: int, arg1: java.io.OutputStream | java.io.OutputStream$$Lambda, arg2: com.sun.xml.internal.ws.api.message.Packet): void
                                ...
                                public getDocumentAddressResolver(arg0: com.sun.xml.internal.ws.api.server.PortAddressResolver | com.sun.xml.internal.ws.api.server.PortAddressResolver$$Lambda): com.sun.xml.internal.ws.api.server.DocumentAddressResolver
