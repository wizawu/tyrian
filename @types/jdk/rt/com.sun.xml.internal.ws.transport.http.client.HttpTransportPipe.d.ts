                        ...
                        namespace http {
                            namespace client {
                                class HttpTransportPipe extends com.sun.xml.internal.ws.api.pipe.helper.AbstractTubeImpl {
                                    ...
                                    protected getTransport(arg0: com.sun.xml.internal.ws.api.message.Packet, arg1: java.util.Map<java.lang.String, java.util.List<java.lang.String>>): com.sun.xml.internal.ws.transport.http.client.HttpClientTransport
