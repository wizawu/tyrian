            ...
            namespace internal {
                namespace ws {
                    namespace transport {
                        namespace http {
                            namespace server {
                                class ServerConnectionImpl extends com.sun.xml.internal.ws.transport.http.WSHTTPConnection implements com.sun.xml.internal.ws.api.server.WebServiceContextDelegate {
                                    public constructor(arg0: com.sun.xml.internal.ws.transport.http.HttpAdapter, arg1: com.sun.net.httpserver.HttpExchange)
                                    ...
                                    public getExchange(): com.sun.net.httpserver.HttpExchange
