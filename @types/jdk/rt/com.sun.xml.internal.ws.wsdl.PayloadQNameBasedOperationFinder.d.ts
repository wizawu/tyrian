    ...
    namespace sun {
        namespace xml {
            namespace internal {
                namespace ws {
                    namespace wsdl {
class PayloadQNameBasedOperationFinder extends com.sun.xml.internal.ws.wsdl.WSDLOperationFinder {
    public static EMPTY_PAYLOAD_LOCAL: string
    public static EMPTY_PAYLOAD_NSURI: string
    public static EMPTY_PAYLOAD: javax.xml.namespace.QName
