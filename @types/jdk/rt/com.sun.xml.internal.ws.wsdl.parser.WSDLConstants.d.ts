...
interface WSDLConstants {
    PREFIX_NS_WSDL: string
    NS_XMLNS: string
    NS_WSDL: string
    NS_SOAP11_HTTP_BINDING: string
    ...
    NS_SOAP_BINDING_ADDRESS: javax.xml.namespace.QName
    NS_SOAP_BINDING: javax.xml.namespace.QName
    NS_SOAP12_BINDING: javax.xml.namespace.QName
    NS_SOAP12_BINDING_ADDRESS: javax.xml.namespace.QName
