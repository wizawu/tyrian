declare namespace java {
    namespace awt {
        class Component$AccessibleAWTComponent$AccessibleAWTComponentHandler implements java.awt.event.ComponentListener {
            protected constructor(arg0: java.awt.Component$AccessibleAWTComponent)
