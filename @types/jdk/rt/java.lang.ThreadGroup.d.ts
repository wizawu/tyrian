...
class ThreadGroup implements java.lang.Thread$UncaughtExceptionHandler {
    ...
    public list(): void
    public parentOf(arg0: java.lang.ThreadGroup | java.lang.ThreadGroup$$Lambda): boolean
    public resume(): void
...
class ThreadGroup$$Lambda implements java.lang.Thread$UncaughtExceptionHandler {
    public constructor(arg0: java.lang.String | string)
}
