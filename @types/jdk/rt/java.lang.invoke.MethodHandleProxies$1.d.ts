declare namespace java {
    namespace lang {
        namespace invoke {
            class MethodHandleProxies$1 implements java.lang.reflect.InvocationHandler {
                public invoke(arg0: java.lang.Object, arg1: java.lang.reflect.Method, arg2: java.lang.Object[]): java.lang.Object
                public static class: java.lang.Class<any>
            }
            class MethodHandleProxies$1$$Lambda implements java.lang.reflect.InvocationHandler {
