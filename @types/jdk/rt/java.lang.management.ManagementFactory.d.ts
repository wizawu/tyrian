    ...
    namespace lang {
        namespace management {
            class ManagementFactory {
                public static readonly CLASS_LOADING_MXBEAN_NAME: string
                public static readonly COMPILATION_MXBEAN_NAME: string
                public static readonly GARBAGE_COLLECTOR_MXBEAN_DOMAIN_TYPE: string
                public static readonly MEMORY_MANAGER_MXBEAN_DOMAIN_TYPE: string
                public static readonly MEMORY_MXBEAN_NAME: string
                public static readonly MEMORY_POOL_MXBEAN_DOMAIN_TYPE: string
                public static readonly OPERATING_SYSTEM_MXBEAN_NAME: string
                public static readonly RUNTIME_MXBEAN_NAME: string
                public static readonly THREAD_MXBEAN_NAME: string
                ...
                public static getPlatformManagementInterfaces<T extends java.lang.management.PlatformManagedObject>(): java.util.Set<java.lang.Class<java.lang.management.PlatformManagedObject>>
