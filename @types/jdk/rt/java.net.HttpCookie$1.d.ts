declare namespace java {
    namespace net {
        class HttpCookie$1 implements java.net.HttpCookie$CookieAttributeAssignor {
            public assign(arg0: java.net.HttpCookie, arg1: java.lang.String | string, arg2: java.lang.String | string): void
            public static class: java.lang.Class<any>
        }
        class HttpCookie$1$$Lambda implements java.net.HttpCookie$CookieAttributeAssignor {
