    ...
    namespace nio {
        namespace channels {
            class Channels {
                ...
                public static newChannel(arg0: java.io.InputStream | java.io.InputStream$$Lambda): java.nio.channels.ReadableByteChannel
                public static newChannel(arg0: java.io.OutputStream | java.io.OutputStream$$Lambda): java.nio.channels.WritableByteChannel
                public static newReader(arg0: java.nio.channels.ReadableByteChannel, arg1: java.nio.charset.CharsetDecoder | java.nio.charset.CharsetDecoder$$Lambda, arg2: int): java.io.Reader
                public static newReader(arg0: java.nio.channels.ReadableByteChannel, arg1: java.lang.String | string): java.io.Reader
                public static newWriter(arg0: java.nio.channels.WritableByteChannel, arg1: java.nio.charset.CharsetEncoder | java.nio.charset.CharsetEncoder$$Lambda, arg2: int): java.io.Writer
