        ...
        namespace channels {
            namespace spi {
                abstract class AsynchronousChannelProvider {
                    ...
                    public abstract openAsynchronousChannelGroup(arg0: int, arg1: java.util.concurrent.ThreadFactory | java.util.concurrent.ThreadFactory$$Lambda): java.nio.channels.AsynchronousChannelGroup
