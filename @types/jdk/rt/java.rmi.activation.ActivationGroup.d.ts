declare namespace java {
    namespace rmi {
        namespace activation {
            ...
            interface ActivationGroup$$Lambda extends java.rmi.server.UnicastRemoteObject implements java.rmi.activation.ActivationInstantiator {
                (arg0: java.rmi.activation.ActivationID, arg1: java.rmi.Remote): void
            }
        }
    }
}