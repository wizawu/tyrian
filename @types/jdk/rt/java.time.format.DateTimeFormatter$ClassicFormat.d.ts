declare namespace java {
    namespace time {
        namespace format {
            class DateTimeFormatter$ClassicFormat extends java.text.Format {
                public constructor(arg0: java.time.format.DateTimeFormatter, arg1: java.time.temporal.TemporalQuery<any> | java.time.temporal.TemporalQuery$$Lambda<any>)
