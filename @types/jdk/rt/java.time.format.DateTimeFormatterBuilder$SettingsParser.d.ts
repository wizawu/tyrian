    ...
    namespace time {
        namespace format {
            class DateTimeFormatterBuilder$SettingsParser extends java.lang.Enum<java.time.format.DateTimeFormatterBuilder$SettingsParser> implements java.time.format.DateTimeFormatterBuilder$DateTimePrinterParser {
                public static readonly SENSITIVE: java.time.format.DateTimeFormatterBuilder$SettingsParser
                public static readonly INSENSITIVE: java.time.format.DateTimeFormatterBuilder$SettingsParser
                public static readonly STRICT: java.time.format.DateTimeFormatterBuilder$SettingsParser
                public static readonly LENIENT: java.time.format.DateTimeFormatterBuilder$SettingsParser
