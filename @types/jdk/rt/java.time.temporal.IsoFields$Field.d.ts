    ...
    namespace time {
        namespace temporal {
            abstract class IsoFields$Field extends java.lang.Enum<java.time.temporal.IsoFields$Field> implements java.time.temporal.TemporalField {
                public static readonly DAY_OF_QUARTER: java.time.temporal.IsoFields$Field
                public static readonly QUARTER_OF_YEAR: java.time.temporal.IsoFields$Field
                public static readonly WEEK_OF_WEEK_BASED_YEAR: java.time.temporal.IsoFields$Field
                public static readonly WEEK_BASED_YEAR: java.time.temporal.IsoFields$Field
