declare namespace java {
    namespace util {
        class IdentityHashMap$EntrySet extends java.util.AbstractSet<java.util.Map$Entry<K, V>> {
            ...
            public spliterator<T>(): java.util.Spliterator<java.util.Map$Entry<K, V>>
