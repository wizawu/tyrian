declare namespace java {
    namespace util {
        class SplittableRandom$RandomDoublesSpliterator implements java.util.Spliterator$OfDouble {
            public trySplit(): java.util.SplittableRandom$RandomDoublesSpliterator
