declare namespace java {
    namespace util {
class SplittableRandom$RandomLongsSpliterator implements java.util.Spliterator$OfLong {
    public trySplit(): java.util.SplittableRandom$RandomLongsSpliterator
