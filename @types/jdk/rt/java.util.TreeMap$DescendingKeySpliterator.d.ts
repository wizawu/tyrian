declare namespace java {
    namespace util {
        class TreeMap$DescendingKeySpliterator<K, V> extends java.util.TreeMap$TreeMapSpliterator<K, V> implements java.util.Spliterator<K> {
            public trySplit(): java.util.TreeMap$DescendingKeySpliterator<K, V>
