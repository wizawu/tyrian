declare namespace java {
    namespace util {
        class WeakHashMap$EntrySpliterator<K, V> extends java.util.WeakHashMap$WeakHashMapSpliterator<K, V> implements java.util.Spliterator<java.util.Map$Entry<K, V>> {
            public trySplit(): java.util.WeakHashMap$EntrySpliterator<K, V>
