declare namespace java {
    namespace util {
        class WeakHashMap$KeySpliterator<K, V> extends java.util.WeakHashMap$WeakHashMapSpliterator<K, V> implements java.util.Spliterator<K> {
            public trySplit(): java.util.WeakHashMap$KeySpliterator<K, V>
