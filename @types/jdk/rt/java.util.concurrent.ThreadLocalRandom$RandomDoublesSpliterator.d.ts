declare namespace java {
    namespace util {
        namespace concurrent {
            class ThreadLocalRandom$RandomDoublesSpliterator implements java.util.Spliterator$OfDouble {
                public trySplit(): java.util.concurrent.ThreadLocalRandom$RandomDoublesSpliterator
