declare namespace java {
    namespace util {
        namespace concurrent {
            class ThreadLocalRandom$RandomIntsSpliterator implements java.util.Spliterator$OfInt {
                public trySplit(): java.util.concurrent.ThreadLocalRandom$RandomIntsSpliterator
