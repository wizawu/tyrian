...
class ThreadLocalRandom$RandomLongsSpliterator implements java.util.Spliterator$OfLong {
    public trySplit(): java.util.concurrent.ThreadLocalRandom$RandomLongsSpliterator
