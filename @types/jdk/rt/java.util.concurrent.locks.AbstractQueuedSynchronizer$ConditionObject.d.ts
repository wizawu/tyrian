declare namespace java {
    namespace util {
        namespace concurrent {
            namespace locks {
                class AbstractQueuedSynchronizer$ConditionObject implements java.util.concurrent.locks.Condition , java.io.Serializable {
                    public constructor(arg0: java.util.concurrent.locks.AbstractQueuedSynchronizer)
                    public signal(): void
