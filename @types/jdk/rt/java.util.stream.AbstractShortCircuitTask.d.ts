    ...
    namespace util {
        namespace stream {
            abstract class AbstractShortCircuitTask<P_IN, P_OUT, R, K extends java.util.stream.AbstractShortCircuitTask<P_IN, P_OUT, R, K>> extends java.util.stream.AbstractTask<P_IN, P_OUT, R, K> {
                protected readonly sharedResult: java.util.concurrent.atomic.AtomicReference<R>
                ...
                protected abstract getEmptyResult(): R
                public compute(): void
            ...
            interface AbstractShortCircuitTask$$Lambda<P_IN, P_OUT, R, K extends java.util.stream.AbstractShortCircuitTask<P_IN, P_OUT, R, K>> extends java.util.stream.AbstractTask<P_IN, P_OUT, R, K> {
                (): R
            }
        }
    }
