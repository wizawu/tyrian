declare namespace java {
    namespace util {
        namespace stream {
            class Nodes$EmptyNode$OfDouble extends java.util.stream.Nodes$EmptyNode<java.lang.Double, double[], java.util.function$.DoubleConsumer> implements java.util.stream.Node$OfDouble {
