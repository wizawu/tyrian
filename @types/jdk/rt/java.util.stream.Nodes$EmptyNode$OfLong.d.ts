declare namespace java {
    namespace util {
        namespace stream {
class Nodes$EmptyNode$OfLong extends java.util.stream.Nodes$EmptyNode<java.lang.Long, long[], java.util.function$.LongConsumer> implements java.util.stream.Node$OfLong {
