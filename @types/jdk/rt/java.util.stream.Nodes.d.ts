    ...
    namespace util {
        namespace stream {
            class Nodes {
                ...
                public static flattenInt<T>(arg0: java.util.stream.Node$OfInt): java.util.stream.Node$OfInt
                public static flattenLong<T>(arg0: java.util.stream.Node$OfLong): java.util.stream.Node$OfLong
                public static flattenDouble<T>(arg0: java.util.stream.Node$OfDouble): java.util.stream.Node$OfDouble
