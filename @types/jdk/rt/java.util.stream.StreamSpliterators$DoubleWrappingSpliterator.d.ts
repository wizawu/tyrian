declare namespace java {
    namespace util {
        namespace stream {
            class StreamSpliterators$DoubleWrappingSpliterator<P_IN> extends java.util.stream.StreamSpliterators$AbstractWrappingSpliterator<P_IN, java.lang.Double, java.util.stream.SpinedBuffer$OfDouble> implements java.util.Spliterator$OfDouble {
