declare namespace java {
    namespace util {
        namespace stream {
            class StreamSpliterators$InfiniteSupplyingSpliterator$OfDouble extends java.util.stream.StreamSpliterators$InfiniteSupplyingSpliterator<java.lang.Double> implements java.util.Spliterator$OfDouble {
