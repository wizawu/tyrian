declare namespace java {
    namespace util {
        namespace stream {
class StreamSpliterators$InfiniteSupplyingSpliterator$OfInt extends java.util.stream.StreamSpliterators$InfiniteSupplyingSpliterator<java.lang.Integer> implements java.util.Spliterator$OfInt {
