declare namespace java {
    namespace util {
        namespace stream {
            class StreamSpliterators$IntWrappingSpliterator<P_IN> extends java.util.stream.StreamSpliterators$AbstractWrappingSpliterator<P_IN, java.lang.Integer, java.util.stream.SpinedBuffer$OfInt> implements java.util.Spliterator$OfInt {
