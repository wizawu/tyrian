declare namespace java {
    namespace util {
        namespace stream {
            class StreamSpliterators$LongWrappingSpliterator<P_IN> extends java.util.stream.StreamSpliterators$AbstractWrappingSpliterator<P_IN, java.lang.Long, java.util.stream.SpinedBuffer$OfLong> implements java.util.Spliterator$OfLong {
