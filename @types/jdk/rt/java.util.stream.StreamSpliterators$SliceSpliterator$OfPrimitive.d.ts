    ...
    namespace util {
        namespace stream {
            abstract class StreamSpliterators$SliceSpliterator$OfPrimitive<T, T_SPLITR extends java.util.Spliterator$OfPrimitive<T, T_CONS, T_SPLITR>, T_CONS> extends java.util.stream.StreamSpliterators$SliceSpliterator<T, T_SPLITR> implements java.util.Spliterator$OfPrimitive<T, T_CONS, T_SPLITR> {
                ...
                protected abstract emptyConsumer(): T_CONS
                public trySplit(): java.util.Spliterator$OfPrimitive
                public static class: java.lang.Class<any>
            }
            interface StreamSpliterators$SliceSpliterator$OfPrimitive$$Lambda<T, T_SPLITR extends java.util.Spliterator$OfPrimitive<T, T_CONS, T_SPLITR>, T_CONS> extends java.util.stream.StreamSpliterators$SliceSpliterator<T, T_SPLITR> implements java.util.Spliterator$OfPrimitive<T, T_CONS, T_SPLITR> {
                (): T_CONS
            }
        }
    }
