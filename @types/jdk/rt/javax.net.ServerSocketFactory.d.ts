declare namespace javax {
    namespace net {
        abstract class ServerSocketFactory {
            ...
            public abstract createServerSocket(arg0: int, arg1: int): java.net.ServerSocket
            public abstract createServerSocket(arg0: int, arg1: int, arg2: java.net.InetAddress): java.net.ServerSocket
