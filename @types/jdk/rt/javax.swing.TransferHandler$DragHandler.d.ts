declare namespace javax {
    namespace swing {
class TransferHandler$DragHandler implements java.awt.dnd.DragGestureListener , java.awt.dnd.DragSourceListener {
    public dragGestureRecognized(arg0: java.awt.dnd.DragGestureEvent): void
