declare namespace javax {
    namespace swing {
        namespace plaf {
            namespace basic {
                class BasicComboBoxUI$Handler implements java.awt.event.ActionListener , java.awt.event.FocusListener , java.awt.event.KeyListener , java.awt.LayoutManager , javax.swing.event.ListDataListener , java.beans.PropertyChangeListener {
