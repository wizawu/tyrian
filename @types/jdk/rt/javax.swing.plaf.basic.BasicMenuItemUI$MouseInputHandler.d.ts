declare namespace javax {
    namespace swing {
        namespace plaf {
            namespace basic {
class BasicMenuItemUI$MouseInputHandler implements javax.swing.event.MouseInputListener {
    protected constructor(arg0: javax.swing.plaf.basic.BasicMenuItemUI)
