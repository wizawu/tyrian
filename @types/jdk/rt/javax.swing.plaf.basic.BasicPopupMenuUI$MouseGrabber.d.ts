declare namespace javax {
    namespace swing {
        namespace plaf {
            namespace basic {
                class BasicPopupMenuUI$MouseGrabber implements javax.swing.event.ChangeListener , java.awt.event.AWTEventListener , java.awt.event.ComponentListener , java.awt.event.WindowListener {
                    public constructor()
