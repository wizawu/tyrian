declare namespace javax {
    namespace swing {
        namespace plaf {
            namespace basic {
                class BasicScrollBarUI$TrackListener extends java.awt.event.MouseAdapter implements java.awt.event.MouseMotionListener {
                    protected offset: int
                    protected currentMouseX: int
                    protected currentMouseY: int
                    protected constructor(arg0: javax.swing.plaf.basic.BasicScrollBarUI)
