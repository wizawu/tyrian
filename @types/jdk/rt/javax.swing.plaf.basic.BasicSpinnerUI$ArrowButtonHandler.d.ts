declare namespace javax {
    namespace swing {
        namespace plaf {
            namespace basic {
                class BasicSpinnerUI$ArrowButtonHandler extends javax.swing.AbstractAction implements java.awt.event.FocusListener , java.awt.event.MouseListener , javax.swing.plaf.UIResource {
