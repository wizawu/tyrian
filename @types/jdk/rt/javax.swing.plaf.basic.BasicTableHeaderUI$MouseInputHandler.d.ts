declare namespace javax {
    namespace swing {
        namespace plaf {
            namespace basic {
                class BasicTableHeaderUI$MouseInputHandler implements javax.swing.event.MouseInputListener {
                    public constructor(arg0: javax.swing.plaf.basic.BasicTableHeaderUI)
