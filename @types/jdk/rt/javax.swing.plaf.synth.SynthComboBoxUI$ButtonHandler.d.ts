declare namespace javax {
    namespace swing {
        namespace plaf {
            namespace synth {
                class SynthComboBoxUI$ButtonHandler extends javax.swing.DefaultButtonModel implements java.awt.event.MouseListener , javax.swing.event.PopupMenuListener {
