        ...
        namespace crypto {
            namespace dsig {
                abstract class XMLSignatureFactory {
                    ...
                    public abstract newXMLSignature(arg0: javax.xml.crypto.dsig.SignedInfo, arg1: javax.xml.crypto.dsig.keyinfo.KeyInfo, arg2: java.util.List, arg3: java.lang.String | string, arg4: java.lang.String | string): javax.xml.crypto.dsig.XMLSignature
                    ...
                    public abstract newReference(arg0: java.lang.String | string, arg1: javax.xml.crypto.dsig.DigestMethod, arg2: java.util.List, arg3: java.lang.String | string, arg4: java.lang.String | string): javax.xml.crypto.dsig.Reference
                    public abstract newReference(arg0: java.lang.String | string, arg1: javax.xml.crypto.dsig.DigestMethod, arg2: java.util.List, arg3: java.lang.String | string, arg4: java.lang.String | string, arg5: byte[]): javax.xml.crypto.dsig.Reference
                    public abstract newReference(arg0: java.lang.String | string, arg1: javax.xml.crypto.dsig.DigestMethod, arg2: java.util.List, arg3: javax.xml.crypto.Data, arg4: java.util.List, arg5: java.lang.String | string, arg6: java.lang.String | string): javax.xml.crypto.dsig.Reference
                    public abstract newSignedInfo(arg0: javax.xml.crypto.dsig.CanonicalizationMethod, arg1: javax.xml.crypto.dsig.SignatureMethod, arg2: java.util.List): javax.xml.crypto.dsig.SignedInfo
                    public abstract newSignedInfo(arg0: javax.xml.crypto.dsig.CanonicalizationMethod, arg1: javax.xml.crypto.dsig.SignatureMethod, arg2: java.util.List, arg3: java.lang.String | string): javax.xml.crypto.dsig.SignedInfo
                    public abstract newXMLObject(arg0: java.util.List, arg1: java.lang.String | string, arg2: java.lang.String | string, arg3: java.lang.String | string): javax.xml.crypto.dsig.XMLObject
                    public abstract newManifest(arg0: java.util.List): javax.xml.crypto.dsig.Manifest
                    public abstract newManifest(arg0: java.util.List, arg1: java.lang.String | string): javax.xml.crypto.dsig.Manifest
                    public abstract newSignatureProperty(arg0: java.util.List, arg1: java.lang.String | string, arg2: java.lang.String | string): javax.xml.crypto.dsig.SignatureProperty
                    public abstract newSignatureProperties(arg0: java.util.List, arg1: java.lang.String | string): javax.xml.crypto.dsig.SignatureProperties
