declare namespace org {
    namespace omg {
        namespace CosNaming {
            ...
            abstract class BindingIteratorPOA$$Lambda extends org.omg.PortableServer.Servant implements org.omg.CosNaming.BindingIteratorOperations , org.omg.CORBA.portable.InvokeHandler {
                public constructor()
            }
        }
    }
