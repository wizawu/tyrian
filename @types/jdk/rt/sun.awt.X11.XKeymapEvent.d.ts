declare namespace sun {
    namespace awt {
        namespace X11 {
class XKeymapEvent extends sun.awt.X11.XWrapperBase {
    ...
    public get_key_vector(arg0: int): byte
    public set_key_vector(arg0: int, arg1: byte): void
    public get_key_vector(): long
