declare namespace sun {
    namespace awt {
        namespace X11 {
            class XMappingEvent extends sun.awt.X11.XWrapperBase {
                ...
                public get_request(): int
                public set_request(arg0: int): void
                public get_first_keycode(): int
                public set_first_keycode(arg0: int): void
