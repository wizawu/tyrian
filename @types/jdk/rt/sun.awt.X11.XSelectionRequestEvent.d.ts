declare namespace sun {
    namespace awt {
        namespace X11 {
class XSelectionRequestEvent extends sun.awt.X11.XWrapperBase {
    ...
    public get_owner(): long
    public set_owner(arg0: long): void
    public get_requestor(): long
    public set_requestor(arg0: long): void
    public get_selection(): long
    public set_selection(arg0: long): void
    public get_target(): long
    public set_target(arg0: long): void
    public get_property(): long
    public set_property(arg0: long): void
