declare namespace sun {
    namespace awt {
        namespace X11 {
class XTrayIconPeer$TrayIconEventProxy implements java.awt.event.MouseListener , java.awt.event.MouseMotionListener {
    public handleEvent(arg0: java.awt.event.MouseEvent): void
