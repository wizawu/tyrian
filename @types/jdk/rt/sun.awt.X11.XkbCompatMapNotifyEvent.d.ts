declare namespace sun {
    namespace awt {
        namespace X11 {
class XkbCompatMapNotifyEvent extends sun.awt.X11.XWrapperBase {
    ...
    public get_first_si(): int
    public set_first_si(arg0: int): void
    public get_num_si(): int
    public set_num_si(arg0: int): void
    public get_num_total_si(): int
    public set_num_total_si(arg0: int): void
