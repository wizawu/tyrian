    ...
    namespace java2d {
        namespace opengl {
            abstract class OGLSurfaceData extends sun.java2d.SurfaceData implements sun.java2d.pipe.hw.AccelSurface {
                ...
                public static readonly PF_INT_ARGB: int
                public static readonly PF_INT_ARGB_PRE: int
                public static readonly PF_INT_RGB: int
                public static readonly PF_INT_RGBX: int
                public static readonly PF_INT_BGR: int
                public static readonly PF_INT_BGRX: int
                public static readonly PF_USHORT_565_RGB: int
                public static readonly PF_USHORT_555_RGB: int
                public static readonly PF_USHORT_555_RGBX: int
                public static readonly PF_BYTE_GRAY: int
                public static readonly PF_USHORT_GRAY: int
                public static readonly PF_3BYTE_BGR: int
                protected type: int
                ...
                protected abstract initPbuffer(arg0: long, arg1: long, arg2: boolean, arg3: int, arg4: int): boolean
            ...
            interface OGLSurfaceData$$Lambda extends sun.java2d.SurfaceData implements sun.java2d.pipe.hw.AccelSurface {
                (arg0: long, arg1: long, arg2: boolean, arg3: int, arg4: int): boolean
            }
        }
    }
}