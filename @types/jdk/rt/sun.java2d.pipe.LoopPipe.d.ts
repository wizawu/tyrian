    ...
    namespace java2d {
        namespace pipe {
            class LoopPipe implements sun.java2d.pipe.PixelDrawPipe , sun.java2d.pipe.PixelFillPipe , sun.java2d.pipe.ParallelogramPipe , sun.java2d.pipe.ShapeDrawPipe , sun.java2d.pipe.LoopBasedPipe {
                ...
                public static getFillSSI(arg0: sun.java2d.SunGraphics2D): sun.java2d.pipe.ShapeSpanIterator
                public static getStrokeSpans(arg0: sun.java2d.SunGraphics2D, arg1: java.awt.Shape): sun.java2d.pipe.ShapeSpanIterator
