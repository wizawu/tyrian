declare namespace sun {
    namespace management {
        class GarbageCollectionNotifInfoCompositeData extends sun.management.LazyCompositeData {
            public constructor(arg0: com.sun.management.GarbageCollectionNotificationInfo | com.sun.management.GarbageCollectionNotificationInfo$$Lambda)
            public getGarbageCollectionNotifInfo(): com.sun.management.GarbageCollectionNotificationInfo
            public static toCompositeData(arg0: com.sun.management.GarbageCollectionNotificationInfo | com.sun.management.GarbageCollectionNotificationInfo$$Lambda): javax.management.openmbean.CompositeData
