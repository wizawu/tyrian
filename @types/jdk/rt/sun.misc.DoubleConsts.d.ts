...
class DoubleConsts {
    ...
    public static SIGNIFICAND_WIDTH: int
    public static MAX_EXPONENT: int
    public static MIN_EXPONENT: int
    public static MIN_SUB_EXPONENT: int
    public static EXP_BIAS: int
    public static SIGN_BIT_MASK: long
    public static EXP_BIT_MASK: long
    public static SIGNIF_BIT_MASK: long
