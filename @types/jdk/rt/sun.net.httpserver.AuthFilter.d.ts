    ...
    namespace net {
        namespace httpserver {
            class AuthFilter extends com.sun.net.httpserver.Filter {
                public constructor(arg0: com.sun.net.httpserver.Authenticator | com.sun.net.httpserver.Authenticator$$Lambda)
                public description(): string
                public setAuthenticator(arg0: com.sun.net.httpserver.Authenticator | com.sun.net.httpserver.Authenticator$$Lambda): void
