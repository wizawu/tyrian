            ...
            namespace protocol {
                namespace jar {
                    class URLJarFile extends java.util.jar.JarFile {
                        ...
                        public constructor(arg0: java.io.File, arg1: sun.net.www.protocol.jar.URLJarFile$URLJarFileCloseController | sun.net.www.protocol.jar.URLJarFile$URLJarFileCloseController$$Lambda)
