declare namespace sun {
    namespace nio {
        namespace cs {
            class ISO_8859_1$Encoder extends java.nio.charset.CharsetEncoder implements sun.nio.cs.ArrayEncoder {
            ...
            class ISO_8859_1$Encoder$$Lambda extends java.nio.charset.CharsetEncoder implements sun.nio.cs.ArrayEncoder {
