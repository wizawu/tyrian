declare namespace sun {
    namespace print {
class ServiceDialog$PrintServicePanel extends javax.swing.JPanel implements java.awt.event.ActionListener , java.awt.event.ItemListener , javax.swing.event.PopupMenuListener {
    public constructor(arg0: sun.print.ServiceDialog)
    public isPrintToFileSelected(): boolean
