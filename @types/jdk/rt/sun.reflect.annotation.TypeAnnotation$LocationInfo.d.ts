...
class TypeAnnotation$LocationInfo {
    ...
    public pushWildcard(): sun.reflect.annotation.TypeAnnotation$LocationInfo
    public pushTypeArg(arg0: short): sun.reflect.annotation.TypeAnnotation$LocationInfo
    public pushLocation(arg0: byte, arg1: short): sun.reflect.annotation.TypeAnnotation$LocationInfo
    public filter(arg0: sun.reflect.annotation.TypeAnnotation[]): sun.reflect.annotation.TypeAnnotation[]
