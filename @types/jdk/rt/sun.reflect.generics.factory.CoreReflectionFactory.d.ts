        ...
        namespace generics {
            namespace factory {
                class CoreReflectionFactory implements sun.reflect.generics.factory.GenericsFactory {
                    public static make(arg0: java.lang.reflect.GenericDeclaration | java.lang.reflect.GenericDeclaration$$Lambda, arg1: sun.reflect.generics.scope.Scope | sun.reflect.generics.scope.Scope$$Lambda): sun.reflect.generics.factory.CoreReflectionFactory
