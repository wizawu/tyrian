        ...
        namespace generics {
            namespace scope {
                abstract class AbstractScope<D extends java.lang.reflect.GenericDeclaration> implements sun.reflect.generics.scope.Scope {
                    ...
                    protected abstract computeEnclosingScope(): sun.reflect.generics.scope.Scope
                ...
                interface AbstractScope$$Lambda<D extends java.lang.reflect.GenericDeclaration> implements sun.reflect.generics.scope.Scope {
