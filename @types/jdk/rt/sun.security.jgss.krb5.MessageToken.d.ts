        ...
        namespace jgss {
            namespace krb5 {
                abstract class MessageToken extends sun.security.jgss.krb5.Krb5Token {
                    ...
                    protected abstract getSealAlg(arg0: boolean, arg1: int): int
                    protected getSgnAlg(arg0: int): int
                    public static class: java.lang.Class<any>
                }
                interface MessageToken$$Lambda extends sun.security.jgss.krb5.Krb5Token {
                    (arg0: boolean, arg1: int): int
                }
            }
        }
    }
