declare namespace sun {
    namespace security {
        namespace provider {
            namespace certpath {
class PKIXTimestampParameters extends java.security.cert.PKIXBuilderParameters {
    public constructor(arg0: java.security.cert.PKIXBuilderParameters, arg1: java.security.Timestamp)
