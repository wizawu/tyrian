    ...
    namespace text {
        namespace normalizer {
            class CharTrie extends sun.text.normalizer.Trie {
                public constructor(arg0: java.io.InputStream | java.io.InputStream$$Lambda, arg1: sun.text.normalizer.Trie$DataManipulate | sun.text.normalizer.Trie$DataManipulate$$Lambda)
