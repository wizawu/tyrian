    ...
    namespace util {
        namespace locale {
            class UnicodeLocaleExtension extends sun.util.locale.Extension {
                public static readonly SINGLETON: char
                public static readonly CA_JAPANESE: sun.util.locale.UnicodeLocaleExtension
                public static readonly NU_THAI: sun.util.locale.UnicodeLocaleExtension
