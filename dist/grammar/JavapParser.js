    ...
    try {
        ...
        while (_alt != 2 && _alt != antlr4.atn.ATN.INVALID_ALT_NUMBER) {
            if (_alt === 1) {
                this.state = 108;
                _la = this._input.LA(1);
                if (!(_la === JavapParser.T__12 || _la === JavapParser.T__13)) {
                    this._errHandler.recoverInline(this);
                }
                else {
                    this._errHandler.reportMatch(this);
...
JavapParser.prototype.type = function () {
    ...
    try {
        ...
        this._errHandler.sync(this);
        _la = this._input.LA(1);
        if (_la === JavapParser.T__15 || _la === JavapParser.T__17) {
            this.state = 121;
            this.typeArguments();
        }
    }
    ...
    try {
        ...
        switch (this._input.LA(1)) {
            ...
            case JavapParser.T__17:
                ...
                this._errHandler.sync(this);
                _la = this._input.LA(1);
                while (_la === JavapParser.T__12 || _la === JavapParser.T__13) {
                    this.state = 136;
                    _la = this._input.LA(1);
                    if (!(_la === JavapParser.T__12 || _la === JavapParser.T__13)) {
                        this._errHandler.recoverInline(this);
...
JavapParser.prototype.classBody = function () {
    ...
    try {
        ...
        this._errHandler.sync(this);
        _la = this._input.LA(1);
        while (((((_la - 8)) & ~0x1f) == 0 && ((1 << (_la - 8)) & ((1 << (JavapParser.T__7 - 8)) | (1 << (JavapParser.T__8 - 8)) | (1 << (JavapParser.T__9 - 8)) | (1 << (JavapParser.T__10 - 8)) | (1 << (JavapParser.T__11 - 8)) | (1 << (JavapParser.T__15 - 8)) | (1 << (JavapParser.T__17 - 8)) | (1 << (JavapParser.T__23 - 8)) | (1 << (JavapParser.T__24 - 8)) | (1 << (JavapParser.T__25 - 8)) | (1 << (JavapParser.T__26 - 8)) | (1 << (JavapParser.T__27 - 8)) | (1 << (JavapParser.T__28 - 8)) | (1 << (JavapParser.Identifier - 8)))) !== 0)) {
            this.state = 160;
            this.classMember();
            this.state = 165;
            this._errHandler.sync(this);
...
JavapParser.prototype.modifier = function () {
    ...
    try {
        ...
        this.state = 177;
        _la = this._input.LA(1);
        if (!((((_la) & ~0x1f) == 0 && ((1 << _la) & ((1 << JavapParser.T__7) | (1 << JavapParser.T__8) | (1 << JavapParser.T__9) | (1 << JavapParser.T__10) | (1 << JavapParser.T__11) | (1 << JavapParser.T__23) | (1 << JavapParser.T__24) | (1 << JavapParser.T__25) | (1 << JavapParser.T__26) | (1 << JavapParser.T__27) | (1 << JavapParser.T__28))) !== 0))) {
            this._errHandler.recoverInline(this);
        }
        else {
            this._errHandler.reportMatch(this);
...
JavapParser.prototype.constructorDeclaration = function () {
    ...
    try {
        ...
        this._errHandler.sync(this);
        _la = this._input.LA(1);
        while ((((_la) & ~0x1f) == 0 && ((1 << _la) & ((1 << JavapParser.T__7) | (1 << JavapParser.T__8) | (1 << JavapParser.T__9) | (1 << JavapParser.T__10) | (1 << JavapParser.T__11) | (1 << JavapParser.T__23) | (1 << JavapParser.T__24) | (1 << JavapParser.T__25) | (1 << JavapParser.T__26) | (1 << JavapParser.T__27) | (1 << JavapParser.T__28))) !== 0)) {
            this.state = 193;
            this.modifier();
            this.state = 198;
            this._errHandler.sync(this);
